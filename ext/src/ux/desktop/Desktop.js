...
Ext.define('Ext.ux.desktop.Desktop', {
    ...
    initComponent: function () {
        ...
        me.shortcutsView.on('dblclick', Ext.emptyFn, me);
    },
    ...
    createDataView: function () {
        ...
        return {
            ...
            store: me.shortcuts || Ext.create('Ext.data.Store',{
    ...
    onShortcutItemClick: function (dataView, record) {
        var me = this,
            ...
            win = module && module.createWindow({ module:module });
    ...
    createWindow: function(config, cls) {
        var me = this, win, cfg = Ext.applyIf(config || {}, {
                iconCls: ( config.icons && config.icons['16'] ) || config.iconCls,
                stateful: false,
                isWindow: true,
        ...
        var useTaskbutton = true;
        if(win.module){
            useTaskbutton = win.module.useTaskButton;
        }
        if(useTaskbutton){
        ...
        win.on({
            ...
            maximize: me.refreshChildModalWindow, // edited patch
            resize: me.refreshChildModalWindow, // edited patch
            show: me.refreshChildModalWindow, // edited patch
            scope: me
        });
    ...
    refreshChildModalWindow: function(win) {
        // edited
        // patch to ext fix modal bug
        Ext.Array.each(Ext.ComponentQuery.query('window', win), function(item){
            if(item.isVisible()){
                item.hide().show()
            }
        })
    ...
    getStartMenu: function(fn, scope){
        var startmenu = this.taskbar && this.taskbar.startMenu;
        Ext.callback(fn || Ext.emptyFn, scope || this, [startmenu]);
        return startmenu;
    }
