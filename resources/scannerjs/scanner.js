! function(global, definition) {
    ...
    var ScannedImage = function(mimeType, srcIsBase64, src, imageInfo) {
    ...
    ScannedImage.prototype.getBase64NoPrefix = function() {
        ...
        return this.srcIsBase64 ? this.base64ToBlob(src) : undefined;
    };
                ...
                for (var o = 0; o < outputs.length; o++) {
                    ...
                    if ((includeOriginals && output.type == "return-base64") || (includeThumbnails && output.type == "return-base64-thumbnail")) {
                        ...
                        for (var r = 0; r < output.result.length; r++) {
                            ...
                            images.push(new ScannedImage(mimeType, true, "data:" + mimeType + ";base64," + output.result[r], imgInfo));
                        }
                    } else {}
                }
            }
