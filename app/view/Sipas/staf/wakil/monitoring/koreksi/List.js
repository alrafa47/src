/*
 * File: app/view/Sipas/staf/wakil/monitoring/koreksi/List.js
 *
...
Ext.define('SIPAS.view.Sipas.staf.wakil.monitoring.koreksi.List', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.sipas_staf_wakil_monitoring_koreksi_list',
            ...
            dockedItems: [
                {
                    ...
                    items: [
                        ...
                        me.processStatusKoreksi({
                            xtype: 'combobox',
                            itemId: 'statusKoreksi',
                            width: 200,
                            editable: false,
                            hideTrigger: true,
                            displayField: 'nama',
    ...
    processStatusKoreksi: function(config) {
        if(!this.isAsistensi)
        {
            return null;
        }
