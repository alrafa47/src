/*
 * File: app/view/Sipas/staf/wakil/atasan/Form.js
 *
...
Ext.define('SIPAS.view.Sipas.staf.wakil.atasan.Form', {
    extend: 'Ext.form.Panel',
    alias: 'widget.sipas_staf_wakil_atasan_form',
    ...
    initComponent: function() {
        ...
        Ext.applyIf(me, {
            items: [
                ...
                {
                    xtype: 'sipas_staf_wakil_atasan_list',
                    flex: 1
                }
            ],
            dockedItems: [
