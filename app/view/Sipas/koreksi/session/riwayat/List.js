/*
 * File: app/view/Sipas/koreksi/session/riwayat/List.js
 *
...
Ext.define('SIPAS.view.Sipas.koreksi.session.riwayat.List', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.sipas_koreksi_session_riwayat_list',
