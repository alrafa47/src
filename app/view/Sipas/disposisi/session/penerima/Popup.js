/*
 * File: app/view/Sipas/disposisi/session/penerima/Popup.js
 *
...
Ext.define('SIPAS.view.Sipas.disposisi.session.penerima.Popup', {
    extend: 'Ext.window.Window',
    alias: 'widget.sipas_disposisi_session_penerima_popup',
