/*
 * File: app/view/Sipas/com/reportfilter/kewenangan/Eksternal.js
 *
...
Ext.define('SIPAS.view.Sipas.com.reportfilter.kewenangan.Eksternal', {
    extend: 'Ext.form.FieldContainer',
    alias: 'widget.sipas_com_reportfilter_kewenangan_eksternal',
    ...
    processComboFilter: function(config) {
        var config = config || {},
            store = [];
