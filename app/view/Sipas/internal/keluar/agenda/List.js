/*
 * File: app/view/Sipas/internal/keluar/agenda/List.js
 *
...
Ext.define('SIPAS.view.Sipas.internal.keluar.agenda.List', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.sipas_internal_keluar_agenda_list',
    ...
    clickToView: true,
    languageCode: 'agenda_surat_keluar_internal_list',
    languageMode: 'title',
    languageable: true,
    isSession: false,
    autoScroll: true,
    title: 'Daftar Agenda Surat Keluar Internal',
    titleAlign: 'left',
    allowDeselect: true,
    columnLines: false,
    disableSelection: true,
    emptyText: 'Tidak ada data',
    store: 'Sipas.internal.keluar.agenda.List',
    ...
    initComponent: function() {
        ...
        Ext.applyIf(me, {
            ...
            dockedItems: [
                me.processToolbarPropertiesEdaran({
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            roleName: 'surat_internal_keluar_insert',
                            action: 'add',
                            roleable: true,
                            itemId: 'tambahAgenda'
                        },
                ...
                me.processToolbarPropertiesEdaran1({
                    xtype: 'toolbar',
                    dock: 'top',
                    itemId: 'toolbarPropertiesEdaran1',
                    layout: {
                        type: 'hbox',
                        defaultMargins: {
                            top: 4,
                    ...
                    items: [
                        ...
                        {
                            xtype: 'sipas_com_button_add',
                            roleName: 'keluar_session_internal_insert',
                            action: 'add',
                            roleable: true,
                ...
                },
                {
                    ...
                    renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                        if(value != "0"){
                            ...
                            if(setuju !== 0){
                                rsetuju = '<span class="badge badge-solid info"><i class="icon ion-md-checkmark green-700 margin-right-4"></i></span><span class="info">'+setuju+' Diterima</span>';
                            }
                            if(pending !== 0){
        ...
        me.processSipasinternalkeluaragendaList(me);
    ...
    processToolbarPropertiesEdaran1: function(config) {
        if(!this.isSession)
        {
            return null;
        }
    ...
    processSipasinternalkeluaragendaList: function(config) {
        var filters = {
            ftype: 'filters',
            encode: true,
            local: false
