/*
 * File: app/view/Sipas/internal/keputusan/agenda/List.js
 *
...
Ext.define('SIPAS.view.Sipas.internal.keputusan.agenda.List', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.sipas_internal_keputusan_agenda_list',
    ...
    clickToView: true,
    languageCode: 'agenda_surat_keputusan_internal_list',
    languageMode: 'title',
    languageable: true,
    isSession: false,
    autoScroll: true,
    title: 'Daftar Agenda Surat Keputusan Internal',
    titleAlign: 'left',
    allowDeselect: true,
    columnLines: false,
    disableSelection: true,
    emptyText: 'Tidak ada data',
    store: 'Sipas.internal.keputusan.agenda.List',
    ...
    initComponent: function() {
        ...
        Ext.applyIf(me, {
                ...
                me.processToolbarPropertiesEdaran({
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            roleName: 'surat_internal_keputusan_insert',
                            action: 'addKolektif',
                            roleable: true,
                            itemId: 'tambahAgendaKolektif',
                            text: 'Tambah Kolektif'
                        },
                        {
                            xtype: 'sipas_com_button_add',
                            roleName: 'surat_internal_keputusan_insert',
                            action: 'addPerorangan',
                            roleable: true,
                            itemId: 'tambahAgendaPerorangan',
                            text: 'Tambah Perorangan'
                        },
                        {
                            xtype: 'button',
                            roleable: true,
            ...
            columns: [
                ...
                },
                {
                    ...
                    filterable: true,
                    languageable: true,
                    languageCode: 'sikeputusan_list_jenis_keputusan',
                    languageMode: 'text',
                    width: 150,
                ...
                },
                {
                    ...
                    languageable: true,
                    languageMode: 'text',
                    languageCode: 'prioritas_agenda_surat_keputusan_internal_list',
                    filter: {
                        type: 'date'
                    },
                    width: 140,
        ...
        me.processSipasinternalkeputusanagendaList(me);
    ...
    processSipasinternalkeputusanagendaList: function(config) {
        var filters = {
            ftype: 'filters',
            encode: true,
            local: false
