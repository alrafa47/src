/*
 * File: app/view/Sipas/internal/masuk/agenda/distribusi/penerima/List.js
 *
...
Ext.define('SIPAS.view.Sipas.internal.masuk.agenda.distribusi.penerima.List', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.sipas_internal_masuk_agenda_distribusi_penerima_list',
    ...
    hideHeaders: true,
    store: 'Sipas.internal.masuk.agenda.distribusi.penerima.List',
            ...
            columns: [
                ...
                },
                {
                    ...
                    renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                        var id = record.getId(),
                            jabatan = record.get('staf_jabatan_nama') ? record.get('staf_jabatan_nama') : '(Tidak ada jabatan)',
