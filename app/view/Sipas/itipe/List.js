/*
 * File: app/view/Sipas/itipe/List.js
 *
...
Ext.define('SIPAS.view.Sipas.itipe.List', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.sipas_itipe_list',
    ...
    clickToView: true,
    title: 'Daftar Tipe Surat Internal',
    allowDeselect: true,
    columnLines: false,
    disableSelection: true,
    emptyText: 'Tidak ada Data',
    store: 'Sipas.itipe.aktif.List',
                ...
                },
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            roleable: true,
                            roleName: 'field_surat_jenis_insert'
                        },
                        {
                        ...
                        },
                        {
                            ...
                            store: {
                                ...
                                data: [
                                    {
                                        value: 'Sipas.itipe.semua.List',
                                        nama: 'Semua'
                                    },
                                    {
                                        value: 'Sipas.itipe.aktif.List',
                                        nama: 'Aktif'
                                    },
                                    {
                                        value: 'Sipas.itipe.nonaktif.List',
                                        nama: 'Tidak Aktif'
                                    }
                                ]
                            },
            ...
            columns: [
                ...
                },
                {
                    ...
                    renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                        var aktif = record.get('itipe_isaktif');
