/*
 * File: app/view/Sipas/riwayat/session/List.js
 *
...
Ext.define('SIPAS.view.Sipas.riwayat.session.List', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.sipas_riwayat_session_list',
