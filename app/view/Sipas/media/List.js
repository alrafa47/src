/*
 * File: app/view/Sipas/media/List.js
 *
...
Ext.define('SIPAS.view.Sipas.media.List', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.sipas_media_list',
    ...
    languageMode: 'title',
    languageable: true,
    title: 'Daftar Media Pengiriman Surat',
    allowDeselect: true,
    columnLines: false,
    disableSelection: true,
    emptyText: 'Tidak ada Data',
    store: 'Sipas.media.aktif.List',
            ...
            columns: [
                ...
                },
                {
                    ...
                    renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                        var aktif = record.get('media_isaktif');
