/*
 * File: app/view/Sipas/session/profile/editor/atasan/List.js
 *
...
Ext.define('SIPAS.view.Sipas.session.profile.editor.atasan.List', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.sipas_session_profile_editor_atasan_list',
    ...
    store: 'Sipas.staf.wakil.atasan.List',
        ...
        Ext.applyIf(me, {
            ...
            columns: [
                ...
                },
                {
                    ...
                    width: 200,
                    sortable: true,
                    dataIndex: 'staf_wakil_staf_nama',
