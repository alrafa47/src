/*
 * File: app/view/Sipas/session/profile/editor/wakil/List.js
 *
...
Ext.define('SIPAS.view.Sipas.session.profile.editor.wakil.List', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.sipas_session_profile_editor_wakil_list',
