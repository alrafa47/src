/*
 * File: app/view/Sipas/session/profile/editor/pgs/List.js
 *
...
Ext.define('SIPAS.view.Sipas.session.profile.editor.pgs.List', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.sipas_session_profile_editor_pgs_list',
