/*
 * File: app/view/Sipas/session/notification/agenda/eksternal/keluar/blmnomor/List.js
 *
...
Ext.define('SIPAS.view.Sipas.session.notification.agenda.eksternal.keluar.blmnomor.List', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.sipas_session_notification_agenda_eksternal_keluar_blmnomor_list',
    ...
    clickToView: true,
    languageCode: 'notif_agd_keluar_blm_nomor_list',
    languageMode: 'title',
    languageable: true,
    titleAlign: 'left',
    allowDeselect: true,
    ...
    store: 'Sipas.session.notification.agenda.eksternal.keluar.blmnomor.List',
    ...
    initComponent: function() {
        ...
        me.processSipassessionnotificationagendaeksternalkeluarblmnomorList(me);
    ...
    processSipassessionnotificationagendaeksternalkeluarblmnomorList: function(config) {
        var filters = {
            ftype: 'filters',
            encode: true,
            local: false
