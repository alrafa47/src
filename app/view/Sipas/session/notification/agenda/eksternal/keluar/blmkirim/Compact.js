/*
 * File: app/view/Sipas/session/notification/agenda/eksternal/keluar/blmkirim/Compact.js
 *
...
Ext.define('SIPAS.view.Sipas.session.notification.agenda.eksternal.keluar.blmkirim.Compact', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.sipas_session_notification_agenda_eksternal_keluar_blmkirim_compact',
    ...
    languageable: true,
    languageMode: 'title',
    languageCode: 'notif_agd_keluar_blm_kirim_list',
    layout: 'border',
        ...
        Ext.applyIf(me, {
            items: [
                me.processList({
                    ...
                    store: 'Sipas.session.notification.agenda.eksternal.keluar.blmkirim.Compact',
                    dockedItems: [
                        {
                            xtype: 'toolbar',
                            dock: 'top',
                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                                ...
                                var tgl = Ext.util.Format.date(record.get('surat_ekspedisi_tgl'), 'd M Y H:i');
                                if(value){
