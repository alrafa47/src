/*
 * File: app/view/Sipas/session/notification/agenda/eksternal/masuk/aktif3/List.js
 *
...
Ext.define('SIPAS.view.Sipas.session.notification.agenda.eksternal.masuk.aktif3.List', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.sipas_session_notification_agenda_eksternal_masuk_aktif3_list',
    ...
    languageable: true,
    languageMode: 'title',
    languageCode: 'notif_agd_masuk_reminder_3_list',
    autoScroll: true,
    titleAlign: 'left',
    allowDeselect: true,
    columnLines: false,
    ...
    store: 'Sipas.session.notification.agenda.eksternal.masuk.aktif3.List',
    ...
    initComponent: function() {
        ...
        me.processSipassessionnotificationagendaeksternalmasukaktif3List(me);
        me.callParent(arguments);
    },

    processSipassessionnotificationagendaeksternalmasukaktif3List: function(config) {
        var filters = {
            ftype: 'filters',
            encode: true,
            local: false
