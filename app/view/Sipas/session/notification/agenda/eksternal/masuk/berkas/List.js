/*
 * File: app/view/Sipas/session/notification/agenda/eksternal/masuk/berkas/List.js
 *
...
Ext.define('SIPAS.view.Sipas.session.notification.agenda.eksternal.masuk.berkas.List', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.sipas_session_notification_agenda_eksternal_masuk_berkas_list',
    ...
    languageable: true,
    languageMode: 'title',
    languageCode: 'notif_agd_masuk_berkas_list',
    autoScroll: true,
    titleAlign: 'left',
    allowDeselect: true,
    columnLines: false,
    ...
    store: 'Sipas.session.notification.agenda.eksternal.masuk.berkas.List',
    ...
    initComponent: function() {
        ...
        me.processSipassessionnotificationagendaeksternalmasukberkasList(me);
        me.callParent(arguments);
    },

    processSipassessionnotificationagendaeksternalmasukberkasList: function(config) {
        var filters = {
            ftype: 'filters',
            encode: true,
            local: false
