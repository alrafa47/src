/*
 * File: app/view/Sipas/session/notification/agenda/eksternal/masuk/aktif1/List.js
 *
...
Ext.define('SIPAS.view.Sipas.session.notification.agenda.eksternal.masuk.aktif1.List', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.sipas_session_notification_agenda_eksternal_masuk_aktif1_list',
    ...
    languageable: true,
    languageMode: 'title',
    languageCode: 'notif_agd_masuk_reminder_1_list',
    autoScroll: true,
    titleAlign: 'left',
    allowDeselect: true,
    columnLines: false,
    ...
    store: 'Sipas.session.notification.agenda.eksternal.masuk.aktif1.List',
    ...
    initComponent: function() {
            ...
            columns: [
                ...
                },
                {
                    ...
                    renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                        var jam = "<div class='supporttext'>"+ Ext.util.Format.date(record.get('surat_properti_buat_tgl'), 'd M Y H:i') +"</div>";
                        if(value){
        ...
        me.processSipassessionnotificationagendaeksternalmasukaktif1List(me);
        me.callParent(arguments);
    },

    processSipassessionnotificationagendaeksternalmasukaktif1List: function(config) {
        var filters = {
            ftype: 'filters',
            encode: true,
            local: false
