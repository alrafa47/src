/*
 * File: app/view/Sipas/session/notification/agenda/internal/masuk/baru/List.js
 *
...
Ext.define('SIPAS.view.Sipas.session.notification.agenda.internal.masuk.baru.List', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.sipas_session_notification_agenda_internal_masuk_baru_list',
    ...
    languageable: true,
    languageMode: 'title',
    languageCode: 'notif_agd_imasuk_baru_list',
    autoScroll: true,
    titleAlign: 'left',
    allowDeselect: true,
    columnLines: false,
    ...
    store: 'Sipas.session.notification.agenda.internal.masuk.baru.List',
    ...
    initComponent: function() {
        ...
        me.processSipassessionnotificationagendainternalmasukbaruList(me);
    ...
    processSipassessionnotificationagendainternalmasukbaruList: function(config) {
        var filters = {
            ftype: 'filters',
            encode: true,
            local: false
