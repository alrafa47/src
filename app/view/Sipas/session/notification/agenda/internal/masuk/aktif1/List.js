/*
 * File: app/view/Sipas/session/notification/agenda/internal/masuk/aktif1/List.js
 *
...
Ext.define('SIPAS.view.Sipas.session.notification.agenda.internal.masuk.aktif1.List', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.sipas_session_notification_agenda_internal_masuk_aktif1_list',
    ...
    languageable: true,
    languageMode: 'title',
    languageCode: 'notif_agd_imasuk_reminder_1_list',
    autoScroll: true,
    titleAlign: 'left',
    allowDeselect: true,
    columnLines: false,
    ...
    store: 'Sipas.session.notification.agenda.internal.masuk.aktif1.List',
    ...
    initComponent: function() {
        ...
        me.processSipassessionnotificationagendainternalmasukaktif1List(me);
    ...
    processSipassessionnotificationagendainternalmasukaktif1List: function(config) {
        var filters = {
            ftype: 'filters',
            encode: true,
            local: false
