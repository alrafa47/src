/*
 * File: app/view/Sipas/session/notification/agenda/internal/masuk/aktif7/List.js
 *
...
Ext.define('SIPAS.view.Sipas.session.notification.agenda.internal.masuk.aktif7.List', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.sipas_session_notification_agenda_internal_masuk_aktif7_list',
    ...
    languageable: true,
    languageMode: 'title',
    languageCode: 'notif_agd_imasuk_reminder_7_list',
    autoScroll: true,
    titleAlign: 'left',
    allowDeselect: true,
    columnLines: false,
    ...
    store: 'Sipas.session.notification.agenda.internal.masuk.aktif7.List',
    ...
    initComponent: function() {
        ...
        me.processSipassessionnotificationagendainternalmasukaktif7List(me);
    ...
    processSipassessionnotificationagendainternalmasukaktif7List: function(config) {
        var filters = {
            ftype: 'filters',
            encode: true,
            local: false
