/*
 * File: app/view/Sipas/retensi/List.js
 *
...
Ext.define('SIPAS.view.Sipas.retensi.List', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.sipas_retensi_list',
    ...
    languageable: true,
    languageMode: 'title',
    languageCode: 'retensi_list',
    title: 'Daftar Masa Aktif Surat',
    allowDeselect: true,
    columnLines: false,
    disableSelection: true,
    emptyText: 'Tidak ada Data',
    store: 'Sipas.retensi.aktif.List',
    ...
    initComponent: function() {
            ...
            columns: [
                ...
                },
                {
                    ...
                    renderer: function(value, metaData, record, rowIndex, colIndex, store, view) {
                        var aktif = record.get('retensi_isaktif');
                ...
                },
                {
                    ...
                    sortable: true,
                    align: 'right',
                    dataIndex: 'retensi_hari',
                    text: 'Lama Masa Aktif (hari)'
                }
            ],
        ...
        me.processSipasretensiList(me);
        me.callParent(arguments);
    },

    processSipasretensiList: function(config) {
        var filters = {
            ftype: 'filters',
            encode: true,
            local: false
