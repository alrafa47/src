/*
 * File: app/model/Sipas/arsip/Bagi.js
 *
...
Ext.define('SIPAS.model.Sipas.arsip.Bagi', {
    ...
    idProperty: 'arsip_bagi_id',

    proxy: {
        type: 'ajax',
        api: {
            read: 'server.php/sipas/arsip/bagi'
        },
        reader: {
            type: 'json',
            root: 'data'
    ...
    fields: [
        ...
        {
            name: 'arsip_bagi_arsip'
        },
        {
            name: 'arsip_bagi_unit'
        },
        {
            name: 'arsip_bagi_bolehubah',
            type: 'boolean'
        },
        {
            name: 'arsip_bagi_bolehhapus',
            type: 'boolean'
        },
        {
            name: 'arsip_id'
        ...
        {
            name: 'arsip_bagi_unit_id'
        },
        {
            name: 'arsip_bagi_unit_kode'
        },
        {
            name: 'arsip_bagi_unit_nama'
        },
        {
            name: 'arsip_bagi_bolehtambah',
            type: 'boolean'
        },
        {
    ...
    bolehUbah: function() {
        if(this.get('arsip_bagi_bolehubah') === true) return true;
        else return false;
    },

    bolehHapus: function() {
        if(this.get('arsip_bagi_bolehhapus') === true) return true;
        else return false;
    },

    bolehTambah: function() {
        if(this.get('arsip_bagi_bolehtambah') === true) return true;
        else return false;
    }
