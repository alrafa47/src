Ext.define('SIPAS.controller.Sipas.session.notification.agenda.eksternal.masuk.aktif7.List', {
    ...
    api: {
        'datasource':'server.php/sipas/notif_agenda/eksternal/masuk_aktif7?scope={scope}'
    },

    refs: [
        { ref: 'mainview',  selector: 'sipas_session_notification_agenda_eksternal_masuk_aktif7_list' }
    ],
    ...
    init: function(application) {
        this.control({
            "sipas_session_notification_agenda_eksternal_masuk_aktif7_list #comboScope": {
                select: this.onComboScope_Select,
                afterrender: this.onComboScope_AfterRender
            },
            "sipas_session_notification_agenda_eksternal_masuk_aktif7_list sipas_com_button_refresh": {
                click: this.onButtonRefresh_Click
            },
            "sipas_session_notification_agenda_eksternal_masuk_aktif7_list": {
                selectionchange: this.onGridpanel_SelectionChange
            },
            'sipas_session_notification_agenda_eksternal_masuk_aktif7_list[clickToView=true]': {
