Ext.define('SIPAS.controller.Sipas.session.notification.agenda.eksternal.masuk.aktif3.List', {
    ...
    api: {
        'datasource':'server.php/sipas/notif_agenda/eksternal/masuk_aktif3?scope={scope}'
    },

    refs: [
        { ref: 'mainview',  selector: 'sipas_session_notification_agenda_eksternal_masuk_aktif3_list' }
    ],
    ...
    init: function(application) {
        this.control({
            "sipas_session_notification_agenda_eksternal_masuk_aktif3_list #comboScope": {
                select: this.onComboScope_Select,
                afterrender: this.onComboScope_AfterRender
            },
            "sipas_session_notification_agenda_eksternal_masuk_aktif3_list sipas_com_button_refresh": {
                click: this.onButtonRefresh_Click
            },
            "sipas_session_notification_agenda_eksternal_masuk_aktif3_list": {
                selectionchange: this.onGridpanel_SelectionChange
            },
            'sipas_session_notification_agenda_eksternal_masuk_aktif3_list[clickToView=true]': {
