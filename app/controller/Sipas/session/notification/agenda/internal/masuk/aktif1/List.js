Ext.define('SIPAS.controller.Sipas.session.notification.agenda.internal.masuk.aktif1.List', {
    ...
    api: {
        'datasource':'server.php/sipas/notif_agenda/internal/masuk_aktif1?scope={scope}'
    },

    refs:[
        { ref : 'mainview',     selector: 'sipas_session_notification_agenda_internal_masuk_aktif1_list'},
        { ref : 'compScope',    selector: 'sipas_session_notification_agenda_internal_masuk_aktif1_list #comboScope' }
    ],
    ...
    init: function(application) {
        this.control({
            "sipas_session_notification_agenda_internal_masuk_aktif1_list #comboScope": {
                select: this.onComboScope_Select,
                afterrender: this.onComboScope_AfterRender
            },
            "sipas_session_notification_agenda_internal_masuk_aktif1_list toolbar sipas_com_button_refresh": {
                click: this.onButtonRefresh_Click
            },
            'sipas_session_notification_agenda_internal_masuk_aktif1_list[clickToView=true]': {
