Ext.define('SIPAS.controller.Sipas.session.notification.agenda.internal.masuk.berkas.List', {
    ...
    api: {
        'datasource':'server.php/sipas/notif_agenda/internal/masuk_reqberkas?scope={scope}'
    },

    refs:[
        { ref : 'mainview',     selector: 'sipas_session_notification_agenda_internal_masuk_berkas_list'},
        { ref : 'compScope',    selector: 'sipas_session_notification_agenda_internal_masuk_berkas_list #comboScope' }
    ],
    ...
    init: function(application) {
        this.control({
            "sipas_session_notification_agenda_internal_masuk_berkas_list #comboScope": {
                select: this.onComboScope_Select,
                afterrender: this.onComboScope_AfterRender
            },
            "sipas_session_notification_agenda_internal_masuk_berkas_list toolbar sipas_com_button_refresh": {
                click: this.onButtonRefresh_Click
            },
            'sipas_session_notification_agenda_internal_masuk_berkas_list[clickToView=true]': {
