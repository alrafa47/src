Ext.define('SIPAS.controller.Sipas.session.notification.agenda.internal.keluar.ulasan.List', {
    ...
    api: {
        'datasource':'server.php/sipas/notif_agenda/internal/keluar_ulasan?scope={scope}'
    },

    refs: [
        { ref: 'mainview',              selector: 'sipas_session_notification_agenda_internal_keluar_ulasan_list' },
        { ref: 'compScope',             selector: 'sipas_session_notification_agenda_internal_keluar_ulasan_list #comboScope' }
    ],
    ...
    init: function(application) {
        this.control({
            "sipas_session_notification_agenda_internal_keluar_ulasan_list #comboScope": {
                select: this.onComboScope_Select,
                afterrender: this.onComboScope_AfterRender
            },
            "sipas_session_notification_agenda_internal_keluar_ulasan_list": {
                afterrender: this.onMainview_AfterRender
            },
            "sipas_session_notification_agenda_internal_keluar_ulasan_list sipas_com_button_refresh": {
                click: this.onButtonRefresh_Click
            },
            "sipas_session_notification_agenda_internal_keluar_ulasan_list[clickToView=true]": {
    ...
    onComboScope_Select: function(combo, selection, eOpts){
        var $this = this,
            ...
            // tipe = $this.getCompTipe({root:mainview}).getValue(),
