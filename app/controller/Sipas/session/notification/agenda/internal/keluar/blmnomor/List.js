Ext.define('SIPAS.controller.Sipas.session.notification.agenda.internal.keluar.blmnomor.List', {
    ...
    api: {
        'datasource':'server.php/sipas/notif_agenda/internal/keluar_blmnomor?scope={scope}'
    },

    refs: [
        { ref: 'mainview',              selector: 'sipas_session_notification_agenda_internal_keluar_blmnomor_list' },
        { ref: 'dataview',              selector: 'sipas_session_notification_agenda_internal_keluar_blmnomor_list dataview' },
        { ref: 'compScope',             selector: 'sipas_session_notification_agenda_internal_keluar_blmnomor_list #comboScope' }
        // { ref: 'compTipe',              selector: 'sipas_session_notification_agenda_internal_keluar_blmnomor_list #comboTipe' }
    ],
    ...
    init: function(application) {
        this.control({
            "sipas_session_notification_agenda_internal_keluar_blmnomor_list #comboScope": {
                select: this.onComboScope_Select,
                afterrender: this.onComboScope_AfterRender
            },
            "sipas_session_notification_agenda_internal_keluar_blmnomor_list": {
                afterrender: this.onMainview_AfterRender
            },
            "sipas_session_notification_agenda_internal_keluar_blmnomor_list sipas_com_button_refresh": {
                click: this.onButtonRefresh_Click
            },
            "sipas_session_notification_agenda_internal_keluar_blmnomor_list[clickToView=true]": {
