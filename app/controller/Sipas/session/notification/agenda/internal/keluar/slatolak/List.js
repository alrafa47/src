Ext.define('SIPAS.controller.Sipas.session.notification.agenda.internal.keluar.slatolak.List', {
    ...
    api: {
        'datasource':'server.php/sipas/notif_agenda/internal/keluar_slatolak?scope={scope}'
    },

    refs: [
        { ref: 'mainview',              selector: 'sipas_session_notification_agenda_internal_keluar_slatolak_list' },
        { ref: 'compScope',             selector: 'sipas_session_notification_agenda_internal_keluar_slatolak_list #comboScope' }
    ],
    ...
    init: function(application) {
        this.control({
            "sipas_session_notification_agenda_internal_keluar_slatolak_list #comboScope": {
                select: this.onComboScope_Select,
                afterrender: this.onComboScope_AfterRender
            },
            "sipas_session_notification_agenda_internal_keluar_slatolak_list": {
                afterrender: this.onMainview_AfterRender
            },
            "sipas_session_notification_agenda_internal_keluar_slatolak_list sipas_com_button_refresh": {
                click: this.onButtonRefresh_Click
            },
            "sipas_session_notification_agenda_internal_keluar_slatolak_list[clickToView=true]": {
