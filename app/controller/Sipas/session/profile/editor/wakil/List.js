Ext.define('SIPAS.controller.Sipas.session.profile.editor.wakil.List', {
    ...
    api: {
        'update_status'  : 'server.php/sipas/staf_wakil/update_status',
        'staf_aktif' : "server.php/sipas/staf/wakil",
        'batas_hirarki' : "server.php/sipas/staf/wakil?mode={mode}&jabatan={jabatan}"
    },

    refs:[
        { ref: 'mainview', selector: 'sipas_session_profile_editor_wakil_list' },
        { ref: 'fieldSearch', selector: 'sipas_session_profile_editor_wakil_list #fieldSearch' }
    ],
    ...
    init: function(application) {
        this.control({
            'sipas_session_profile_editor_wakil_list': {
            ...
            'sipas_session_profile_editor_wakil_list #fieldSearch': {
                focus: this.onFieldSearch_Focus,
                select: this.onMainview_fieldSearch_Select
            },
            'sipas_session_profile_editor_wakil_list #buttonManual': {
    ...
    onFieldSearch_Focus: function(cmp, eOpts){
        ...
        if (batas_hirarki){
            store.getProxy().url = $this.getApi('batas_hirarki', {mode:'asisten', jabatan:$profile.jabatan_id});
        } else {
    ...
    onMainview_buttonManual_Click: function(button, e, eOpts){
        var $this = this,
            ...
            // timId = view.up('sipas_session_profile_editor_wakil_form').down('[name=staf_wakil_id]');
