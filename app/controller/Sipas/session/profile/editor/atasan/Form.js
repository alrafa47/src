Ext.define('SIPAS.controller.Sipas.session.profile.editor.atasan.Form', {
    ...
    refs:[
        { ref: 'mainview',  selector: 'sipas_session_profile_editor_atasan_form' },
        { ref: 'grid',      selector: 'sipas_session_profile_editor_atasan_form grid' }
    ],
    ...
    init: function(application) {
        this.control({
            'sipas_session_profile_editor_atasan_form': {
