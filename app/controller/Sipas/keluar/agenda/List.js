Ext.define("SIPAS.controller.Sipas.keluar.agenda.List", {
  ...
  views: ["Sipas.keluar.agenda.List"],
  ...
  api: {
    ...
    datasource2:
      "server.php/sipas/account/surat_keluar/{section}?scope={scope}",
  },
  ...
  refs: [
    ...
    {
      ref: "comStatusSession",
      selector: "sipas_keluar_agenda_list #comboStatusSession",
    },
  ],
    ...
    var $this = this,
      ...
      comboList = [
        ...
        },
        {
          ...
          roleName: null,
          languageable: true,
          languageCode: $this.lgKeluarDraft,
        },
        {
          value: 2,
          nama: null,
          ...
          roleName: null,
          languageable: true,
          languageCode: $this.lgKeluarDlmSetuju,
        },
        {
          value: 3,
          nama: null,
          ...
          roleName: null,
          languageable: true,
          languageCode: $this.lgKeluarSetuju,
        },
        {
          value: 4,
          nama: null,
          ...
          roleName: null,
          languageable: true,
          languageCode: $this.lgKeluarRevisi,
        },
        {
          value: 5,
          nama: null,
          ...
          roleName: null,
          languageable: true,
          languageCode: $this.lgKeluarBlmNomor,
        },
        {
          value: 6,
          nama: null,
          ...
          roleName: null,
          languageable: true,
          languageCode: $this.lgKeluarBlmEkspedisi,
        },
        {
          value: 7,
          nama: null,
          ...
          roleName: null,
          languageable: true,
          languageCode: $this.lgKeluarSdhEkspedisi,
        },
        {
          value: 8,
          nama: null,
          featureable: true,
          featureName: $this.batalNomor,
          roleable: false,
          roleName: null,
          languageable: true,
          languageCode: $this.lgKeluarBatalNomor,
        },
        {
          value: 9,
          nama: null,
          ...
          roleName: null,
          languageable: true,
          languageCode: $this.lgKeluarSalinNomor,
        },
        {
          value: 10,
          nama: null,
          ...
          roleName: null,
          languageable: true,
          languageCode: $this.lgKeluarAktif,
        },
        {
          value: 11,
          nama: null,
          ...
          roleName: null,
          languageable: true,
          languageCode: $this.lgKeluarNonaktif,
        },
        {
          value: 12,
          nama: null,
          ...
          roleName: null,
          languageable: true,
          languageCode: $this.lgKeluarTerlewatNonaktif,
        },
      ],
  ...
  onMainview_ClickShow: function (model, selected, eOpts) {
    var $this = this,
      ...
      inaktif_display = Ext.util.Format.date(inaktif_tgl, "d M Y")
        ? Ext.util.Format.date(inaktif_tgl, "d M Y")
        : "",
      controllerProperty = $this.getController($this.controllerProperty),
    ...
    if (useretensi && is_inaktif) {
      $helper.showMsg({
        success: false,
        message: "Surat telah melewati masa inaktif",
      });
    } else {
      ...
      if (view.isSession) {
        if (record && record.get("surat_properti_pembuat_id") == my_id) {
          ...
          if (role_lihat) {
            ...
            $helper.showMsg({
              success: false,
              message: "Anda bukan pembuat surat ini",
            });
          }
        }
      } else {
  ...
  onComboScope_AfterRender: function (component, eOpts, button) {
    ...
    component.getStore().load({
      callback: function (record, operation, success) {
        component.setLoading(false);
        component.setValue(profile.unit_induk);
  ...
  updateList: function (scope, mainview) {
    ...
    if (mainview.isSession) {
      ...
      store.removeAll();
      proxy.url = $this.getApi("datasource2", {
        section: status,
        scope: scope,
      });
    } else {
