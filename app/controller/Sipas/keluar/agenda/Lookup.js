Ext.define('SIPAS.controller.Sipas.keluar.agenda.Lookup', {
    ...
    refs: [
        { ref: 'mainview',  selector: 'sipas_keluar_agenda_lookup'},
        { ref: 'grid',      selector: 'sipas_keluar_agenda_lookup grid'},
        { ref: 'putin',     selector: 'sipas_keluar_agenda_lookup sipas_com_button_putin'},
        { ref: 'compScope',  selector: 'sipas_keluar_agenda_lookup #comboScope' }
    ],

    defaultStore: 'Sipas.keluar.agenda.Lookup',

    init: function(application) {
        this.control({
            "sipas_keluar_agenda_lookup sipas_com_button_putin": {
                click: this.onButtonPutin_Click
            },
            "sipas_keluar_agenda_lookup grid": {
                selectionchange: this.onGridpanel_SelectionChange
            },
            "sipas_keluar_agenda_lookup #comboScope": {
