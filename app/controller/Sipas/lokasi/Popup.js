Ext.define('SIPAS.controller.Sipas.lokasi.Popup', {
    ...
    refs : [
        { ref: 'mainview',  selector: 'sipas_lokasi_popup' },
        { ref: 'grid',      selector: 'sipas_lokasi_popup > grid' }
    ],
    ...
    storeList: 'Sipas.lokasi.aktif.List',
    ...
    launch: function(config){
        ...
        var $this = this,
            view = $this.getView('Sipas.lokasi.Popup').create(config),
