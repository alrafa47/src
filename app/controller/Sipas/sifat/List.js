Ext.define('SIPAS.controller.Sipas.sifat.List', {
    extend: 'SIPAS.controller.Sipas.base.Base',

    stores: [
        'Sipas.sifat.semua.List',
        'Sipas.sifat.aktif.List',
        'Sipas.sifat.nonaktif.List',
        'Sipas.sifat.Combo'
    ],
    models: [
        'Sipas.Sifat'
    ...
    refs:[
        { ref: 'mainview', selector: 'sipas_sifat_list' }
    ],

    defaultStore: 'Sipas.sifat.aktif.List',
    controllerProperty: 'Sipas.sifat.Prop',

    init: function(application) {
        this.control({
            "sipas_sifat_list sipas_com_button_add": {
                click: this.onButtonAdd_Click
            },
            "sipas_sifat_list sipas_com_button_refresh": {
                click: this.onButtonRefresh_Click
            },
            "sipas_sifat_list #Aktif": {
                select: this.onComboStatus_Select
            },
            "sipas_sifat_list": {
                selectionchange: this.onGridpanel_SelectionChange
            },
            'sipas_sifat_list[clickToView=true]': {
                itemclick: this.onMainview_ClickShow
            },
            'sipas_sifat_list[dbclickToView=true]': {
    ...
    onComboStatus_Select: function(combo, selection, eOpts){
        ...
        switch(value){
            case 1:
                store.removeAll();
                store.getProxy().url = 'server.php/sipas/sifat/aktif';
            break;
            case 2:
                store.removeAll();
                store.getProxy().url = 'server.php/sipas/sifat/nonaktif';
            break;
            default:
                store.removeAll();
                store.getProxy().url = 'server.php/sipas/sifat/read';
            break;
        }
