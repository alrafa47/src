Ext.define('SIPAS.controller.Sipas.sistem.mobile.url.Popup', {
    ...
    refs: [
    	{ref: 'mainview', 		selector: 'sipas_sistem_mobile_url_popup'},
    	{ref: 'imgServer',   	selector: 'sipas_sistem_mobile_url_popup #imgServer'},
        {ref: 'textServer',   	selector: 'sipas_sistem_mobile_url_popup #textServer'}
    ],

    init: function(application){
    	this.control({
    		'sipas_sistem_mobile_url_popup': {
                'show': this.onMainview_Show,
                'loadserver': this.onMainview_LoadServer
            },
            'sipas_sistem_mobile_url_popup #buttonDownload': {
