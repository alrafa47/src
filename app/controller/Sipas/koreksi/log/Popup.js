Ext.define('SIPAS.controller.Sipas.koreksi.log.Popup', {
    ...
    stores: [
        'Sipas.koreksi.masuk.log.Popup'
    ],

    refs: [
        { ref: 'mainview',     selector: 'sipas_koreksi_log_popup' },
        { ref: 'form',     selector: 'sipas_koreksi_log_popup > form' },
        { ref: 'list',     selector: 'sipas_koreksi_log_popup #listLog' }
    ],

    init: function(application) {
        this.control({
            'sipas_koreksi_log_popup': {
                afterrender: this.onMainview_AfterRender,
                close: this.onMainview_Close
            },
            'sipas_koreksi_log_popup #listLog': {
