Ext.define("SIPAS.controller.Sipas.koreksi.session.Prop", {
  ...
  api: {
    ...
    urutan_setuju:
      "server.php/sipas/surat_stack/status_urutan_setuju?sort={sorter}&filter={filter}",
  ...
  views: ["Sipas.koreksi.session.Prop"],

  models: ["Sipas.koreksi.Masuk", "Sipas.Surat", "Sipas.disposisi.masuk.Log"],
  ...
  refs: [
    ...
    { ref: "form", selector: "sipas_koreksi_session_prop > form" },
    {
      ref: "txtKomentar",
      selector:
        "sipas_koreksi_session_prop > form sipas_surat_informasi_tanggapan_pane [name=surat_stack_komentar]",
    },
    {
      ref: "cmpAdditionalStatus",
      selector:
        "sipas_koreksi_session_prop > form sipas_surat_informasi_tanggapan_pane [name=keterangan_status]",
    },
    {
      ref: "btnSave",
      selector:
        "sipas_koreksi_session_prop > form sipas_surat_informasi_tanggapan_pane sipas_com_button_savesend",
    },
    {
      ref: "btnUbah",
      selector:
        "sipas_koreksi_session_prop > form sipas_surat_informasi_tanggapan_pane #ubah",
    },
    {
      ref: "cmpButtonDecline",
      selector: "sipas_koreksi_session_prop > form #buttonRevision",
    },
    {
      ref: "cmpButtonApprove",
      selector: "sipas_koreksi_session_prop > form #buttonApprove",
    },
    {
      ref: "compPengirimImage",
      selector:
        "sipas_koreksi_session_prop > form sipas_com_disposisi_pengirim_pane #pengirimImg",
    },
    {
      ref: "cbUrut",
      selector:
        "sipas_koreksi_session_prop > form sipas_surat_penyetuju_list [name=surat_setuju_isurut]",
    },
    {
      ref: "paneSurat",
      selector: "sipas_koreksi_session_prop > form sipas_com_surat_pane",
    },
    {
      ref: "compJenisSurat",
      selector: "sipas_koreksi_session_prop > form #jenisSurat",
    },
    {
      ref: "compPengirimSurat",
      selector: "sipas_koreksi_session_prop > form #suratPengirim",
    },
    {
      ref: "compDetailPengirim",
      selector: "sipas_koreksi_session_prop > form #pengirimDetail",
    },
    {
      ref: "compDetailSurat",
      selector: "sipas_koreksi_session_prop > form #suratDetail",
    },
    {
      ref: "compTanggapan",
      selector:
    ...
    {
      ref: "btnPenyetuju",
      selector: "sipas_koreksi_session_prop #buttonPenyetuju",
    },
    {
      ref: "comDetailSurat",
      selector:
        "sipas_koreksi_session_prop > form sipas_surat_informasi_detail_pane",
    },
    {
      ref: "containerInformasi",
      selector: "sipas_koreksi_session_prop > form sipas_surat_informasi_pane",
    },
    {
      ref: "txtInfoTerima",
      selector: "sipas_koreksi_session_prop > form #txtInfoTerima",
    },
    {
      ref: "txtPenerima",
      selector: "sipas_koreksi_session_prop > form #txtPenerima",
    },
    {
      ref: "txtUrutanSetuju",
      selector:
        "sipas_koreksi_session_prop > form sipas_koreksi_session_informasi_penyetujuan_pane #txtUrutanSetuju",
    },
    {
      ref: "cmpUrutanSetuju",
      selector:
    ...
    {
      ref: "containerArsip",
      selector: "sipas_koreksi_session_prop > form sipas_arsip_pane",
    },
    {
      ref: "containerSurat",
      selector: "sipas_koreksi_session_prop > form #containerSurat",
    },
    {
      ref: "containerUrutanSetuju",
      selector: "sipas_koreksi_session_prop > form #containerUrutanSetuju",
    },
    {
      ref: "containerInfoKoreksi",
      selector: "sipas_koreksi_session_prop > form #containerInfoKoreksi",
    },
    {
      ref: "containerTanggapan",
      selector:
        "sipas_koreksi_session_prop > form sipas_surat_informasi_tanggapan_pane",
    },
    {
      ref: "penyetujuList",
      selector: "sipas_koreksi_session_prop > form #list",
    },
    {
      ref: "petikanList",
      selector: "sipas_koreksi_session_prop > form #listPetikan",
    },
    {
      ref: "buttonPengingat",
      selector: "sipas_koreksi_session_prop #buttonPengingat",
    },
      ...
      case "edit":
        view = $this.createView(
          (function (c) {
            ...
            if (
              c.record.get("disposisi_masuk_status") == 2 ||
              c.record.get("disposisi_masuk_status") == 4
            ) {
              c.removeComponents.push("#buttonUbah");
            }
            if (
              c.record.get("disposisi_masuk_staf") == stafId ||
              c.record.get("disposisi_masuk_ispengingat") == 1 ||
              c.record.get("disposisi_masuk_status") == 2 ||
              c.record.get("disposisi_masuk_status") == 4
            ) {
            ...
            if (c.record.get("disposisi_masuk_plt") == 1) {
              c.disableComponents.push(
                ...
                "#btnMore",
                "#buttonTujuan",
                "sipas_surat_informasi_tanggapan_pane"
              );
            } else {
        ...
        var comInformasiSurat = $this.getContainerInformasi({ root: view }),
          ...
          com2 = comInformasiSurat.down(
            "sipas_surat_informasi_penyetujuan_pane"
          ),
          com3 = comInformasiSurat.down("sipas_surat_informasi_terima_pane"),
          com4 = comInformasiSurat.down(
            "sipas_surat_informasi_distribusi_pane"
          ),
          com5 = comInformasiSurat.down(
            "sipas_surat_informasi_ekspedisi_keluar_pane"
          ),
        ...
        if (com1) {
          com1.associated = false;
        }
        if (com2) {
          com2.associated = false;
        }
        if (com3) {
          com3.associated = false;
        }
        if (com4) {
          com4.associated = false;
        }
        if (com5) {
          com5.associated = false;
        }
        if (com6) {
          com6.associated = false;
        }
        if (com7) {
          com7.associated = false;
        }
        if (com8) {
          com8.associated = false;
        }
        if (com9) {
          com9.associated = false;
        }
        if (com10) {
          com10.associated = false;
        }
  ...
  onMainview_Show: function (view) {
    ...
    if (btnTujuan) {
      btnTujuan.setText(
        $app.getGrammar("sipas_koreksi_session_buttontujuan", false)
      );
    }

    if (record.get("disposisi_masuk_plt") == 1) {
      var tplPgsAktif =
        '<div class="cell-text margin-top-4 margin-right-4 margin-bottom-4 margin-left-4">' +
        '<div class="subtext">' +
        $language.getGrammar("disposisi_pgs_aktif", false) +
        "</div>" +
        "</div>";
  ...
  onTanggapan_LoadAssociate: function (record, form, cmp) {
    var $this = this,
      ...
      tgl_koreksi = Ext.Date.format(
        record.get("disposisi_masuk_status_tgl"),
        "d M Y H:i"
      ),
      ...
      if (is_urut) {
        ...
        cmpAdditionalStatus.setValue(
          tpl.apply({
            ...
            komentar: record.get("disposisi_masuk_pesan")
              ? record.get("disposisi_masuk_pesan")
              : '<span class="alternative">(Tidak ada komentar)</span>',
          })
        );
        // btnSave.hide(false);
        // btnUbah.hide(false);
  ...
  onInfoKoreksi_LoadAssociate: function (record, form, cmp) {
    ...
    var $this = this,
      ...
      jabatan = record.get("disposisi_masuk_penerima_jabatan_nama")
        ? record.get("disposisi_masuk_penerima_jabatan_nama")
        : "(Tidak ada jabatan)",
      unit = record.get("disposisi_masuk_penerima_unit_nama")
        ? record.get("disposisi_masuk_penerima_unit_nama")
        : "(Tidak ada unit)",
      penyetujuTitle = "";
    ...
    if (record.get("surat_model") == 6 && record.get("surat_model_sub") != 1) {
      if (record.get("disposisi_model_sub") == 0) {
        penyetujuTitle =
          '<div><div class="maintext margin-bottom-4">Kolektif :</div>';
      } else {
        penyetujuTitle =
          '<div><div class="maintext margin-bottom-4">Petikan :</div>';
      }
    }

    txtInfoTerima.setValue(
      '<span class="supporttext supporttext-dark margin-left-40">menerima <span class="bold">' +
        $app.getGrammar("draft_session", false) +
        "</span> pada " +
        Ext.Date.format(record.get("disposisi_tgl"), "d M Y H:i") +
        "</span>"
    );
    txtPenerima.setValue(
      penyetujuTitle +
        '<div style="display:flex"><div class="cell-visual cell-visual-left">' +
        '<img class="img img-circle img-32" src="server.php/sipas/staf/get_image/foto?id=' +
        record.get("disposisi_masuk_penerima_id") +
        '"></div>' +
        '<div class="cell-text">' +
        '<div class="maintext">' +
        record.get("disposisi_masuk_penerima_nama") +
        "</div>" +
  ...
  onUrutanPenyetujuan_LoadAssociate: function (record, form, cmp) {
    var $this = this,
      mainview = $this.getMainview({ from: cmp }),
      containerUrutanSetuju = $this.getContainerUrutanSetuju({
        root: mainview,
      }),
        ...
        koreksi.getSurat(function (surat) {
          ...
          koreksi.load(function (rec_koreksi) {
            ...
            koreksi.each(function (rec) {
              var find = storeRiwayat.findRecord(
                  "disposisi_id",
                  rec.get("disposisi_id")
                ),
                data = rec.getData();
              ...
              if (!find) {
                if (status == 0) {
                  if (
                    rec.get("disposisi_masuk_id") !=
                    record.get("disposisi_masuk_id")
                  ) {
            ...
            // do not remove this
            if (
              (txtUrutanSetuju.getValue().match(/row-wrap/g) || []).length <
                2 &&
              status != 0
            ) {
            ...
            if (txtUrutanSetuju.getValue().search("cell") < 0) {
              ...
              containerInfoKoreksi &&
                containerInfoKoreksi.addCls("x-dataview-timeline-node-start");
            }
          });
        });
      });
  ...
  onStatusPenyetujuan_LoadAssociate: function (record, form, cmp) {
    ...
    var $this = this,
      ...
      is_urut = record && record.get("surat_setuju_isurut") == 1 ? true : false,
      filters = [{ property: "surat_stack_surat", value: disposisi_surat }],
      sorters = [{ property: "surat_stack_level", direction: "ASC" }];

    if (is_urut) {
      Ext.Ajax.request({
        url: $this.getApi("urutan_setuju", {
          sorter: Ext.encode(sorters),
  ...
  onPetikanList_LoadAssociate: function (record, form, cmp) {
    var $this = this,
      ...
      is_urut =
        record && record.get("surat_petikan_setuju_isurut") == 1 ? true : false,
      id = record.get("surat_id");
  ...
  onButtonUbahSurat_Click: function (button, e, eOpts) {
    var $this = this,
      ...
      controllerIKeputusan = $this.getController(
        $this.controllerSuratIKeputusan
      );
                ...
                if (ttd_akhir) {
                  if (staf_akhir == dm_staf) {
                      ...
                      callback: function (success, records) {
                        ...
                        log.status({
                          ...
                          callback: function (staf, operation, success) {
                            $helper.showMsg({
                              success: true,
                              message: "Berhasil menyimpan tanggapan",
                            });
                          },
                        });
                        Ext.callback(view.callback, view, [
                          success,
                          record,
                          eOpts,
                        ]);
                    ...
                    record.setStatus({
                      ...
                      status:
                        surat.self.statusPenyetujuan().PERSETUJUAN_APPROVE,
                      tgl: now,
                      success: Ext.emptyFn,
                      failure: Ext.emptyFn,
                      callback: Ext.emptyFn,
  ...
  onButtonSaveRevisi_Click: function (button, e, eOpts, record) {
    ...
    if (!txtKomentar.getValue()) {
      $helper.showMsg({
        success: false,
        message: $this.getMessage("empty_coment"),
      });
    } else {
      $this._click++;
      if ($this._click <= 1) {
  ...
  onButtonTujuan_Click: function (button, e, eOpts) {
    var $this = this,
      view = $this.getMainview({ from: button }),
      form = $this.getForm({ root: view }),
      controllerPropPenerima = $this.getController(
        $this.controllerPopupPenerima
      ),
      record = form && form.updateRecord().getRecord(),
      koreksi = record.getKoreksi(),
      surat = koreksi.getSurat(),
  ...
  onButtonDaftarTembusan_Click: function (button, e, eOpts) {
    var $this = this,
      ...
      controllerPropStack = $this.getController(
        $this.controllerPopupTembusanStack
      ),
      controllerPopupPenerima = $this.getController(
        $this.controllerPopupPenerima
      ),
      record = form && form.updateRecord().getRecord(),
      koreksi = record.getKoreksi(),
  ...
  onButtonRiwayatPenyetujuan_Click: function (button, e, eOpts) {
    ...
    record.getKoreksi(function (koreksi) {
      koreksi.getSurat(function (surat) {
        if (
          surat.get("surat_model") == 2 ||
          surat.get("surat_model") == 4 ||
          surat.get("surat_model") == 6
        ) {
          controllerProp.launch({
            mode: "view",
            record: surat,
        ...
        if (surat) {
          if (
            ...
            link =
              ...
              $this.getApi("print_approval", { id: surat.getId() });
            var view = viewer
              .create({
                modal: true,
                height: 600,
          ...
          Ext.Ajax.request({
            ...
            success: function (response, eOpts) {
              ...
              if (!success) {
                $helper.showMsg({
                  success: false,
                  message: "Gagal mengingatkan pimpinan",
                });
                return;
              }
              if (success) {
                $helper.showMsg({
                  success: true,
                  message: "Berhasil mengingatkan pimpinan",
                });
                view.close();
              }
            },
