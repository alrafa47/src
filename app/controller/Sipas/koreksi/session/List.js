Ext.define('SIPAS.controller.Sipas.koreksi.session.List', {
    ...
    refs: [
        ...
        { ref: 'compApprovalInfo',  selector: 'sipas_koreksi_session_list sipas_konsep_info_pane' },
        { ref: 'compApprovalDetail',selector: 'sipas_koreksi_session_list sipas_surat_penyetujuan_detail_pane' },
        { ref: 'compInfo',          selector: 'sipas_koreksi_session_list #groupInfo' },
        { ref: 'status',            selector: 'sipas_koreksi_session_list #Status' },
        { ref: 'statusKoreksi',     selector: 'sipas_koreksi_session_list #statusKoreksi' }
    ],
    ...
    onComboStatus_Select: function(combo, selection, eOpts){
        ...
        switch(value){
            ...
            case 1:
                store.removeAll();
                store.getProxy().url = 'server.php/sipas/draft/blmtindak';
            break;

            // Setuju
            case 2:
                store.removeAll();
                store.getProxy().url = 'server.php/sipas/draft/setuju';
            break;

            // Tolak
            case 3:
                store.removeAll();
                store.getProxy().url = 'server.php/sipas/draft/tolak';
            break;

            // Semua
            default:
                store.removeAll();
                store.getProxy().url = 'server.php/sipas/draft/read';
            break;
        }
