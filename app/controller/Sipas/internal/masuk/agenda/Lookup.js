Ext.define('SIPAS.controller.Sipas.internal.masuk.agenda.Lookup', {
    ...
    api: {
        'datasource':'server.php/sipas/surat_imasuk/aktif?scope={scope}&tipe=all'
    },
    ...
    refs: [
        { ref: 'mainview',  selector: 'sipas_internal_masuk_agenda_lookup'},
        { ref: 'grid',      selector: 'sipas_internal_masuk_agenda_lookup grid'},
        { ref: 'putin',     selector: 'sipas_internal_masuk_agenda_lookup sipas_com_button_putin'},
        { ref: 'compScope',  selector: 'sipas_internal_masuk_agenda_lookup #comboScope' }
    ],

    defaultStore: 'Sipas.internal.masuk.agenda.Lookup',

    init: function(application) {
        this.control({
            "sipas_internal_masuk_agenda_lookup sipas_com_button_putin": {
                click: this.onButtonPutin_Click
            },
            "sipas_internal_masuk_agenda_lookup grid": {
                selectionchange: this.onGridpanel_SelectionChange
            },
            "sipas_internal_masuk_agenda_lookup #comboScope": {
