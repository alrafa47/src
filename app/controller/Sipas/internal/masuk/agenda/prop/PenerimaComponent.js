Ext.define('SIPAS.controller.Sipas.internal.masuk.agenda.prop.PenerimaComponent', {
    extend: 'SIPAS.controller.Sipas.base.Base',

    refs : [
        { ref: 'mainview',      selector: 'sipas_internal_masuk_agenda_prop' },
        { ref: 'component',     selector: 'sipas_internal_masuk_agenda_prop sipas_internal_agenda_penerima_list' }
    ],

    init: function(application) {
        this.control({
            'sipas_internal_masuk_agenda_prop sipas_internal_agenda_penerima_list': {
