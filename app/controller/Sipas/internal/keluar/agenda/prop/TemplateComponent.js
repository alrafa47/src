Ext.define('SIPAS.controller.Sipas.internal.keluar.agenda.prop.TemplateComponent', {
    extend: 'SIPAS.controller.Sipas.base.Base',

    refs : [
        { ref: 'mainview',      selector: 'sipas_internal_keluar_agenda_prop' },
        { ref: 'form',          selector: 'sipas_internal_keluar_agenda_prop > form' },
        { ref: 'component',     selector: 'sipas_internal_keluar_agenda_prop #paneTemplate' },
        { ref: 'editor',        selector: 'sipas_internal_keluar_agenda_prop #paneTemplate sipas_com_ckeditor' },
        { ref: 'templateMaster',selector: 'sipas_internal_keluar_agenda_prop #paneTemplate [name=surat_internal_template]' }
    ],
    ...
    init: function(application) {
        this.control({
            'sipas_internal_keluar_agenda_prop #paneTemplate #buttonTemplate': {
                click: this.onButtonTemplate_Click
            },
            'sipas_internal_keluar_agenda_prop #paneTemplate #buttonEdit': {
                click: this.onButtonEdit_Click
            },
            'sipas_internal_keluar_agenda_prop #paneTemplate #buttonPrint': {
