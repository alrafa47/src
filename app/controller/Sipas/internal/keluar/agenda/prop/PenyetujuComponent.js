Ext.define('SIPAS.controller.Sipas.internal.keluar.agenda.prop.PenyetujuComponent', {
    extend: 'SIPAS.controller.Sipas.base.Base',

    refs : [
        { ref: 'mainview',      selector: 'sipas_internal_keluar_agenda_prop' },
        { ref: 'component',     selector: 'sipas_internal_keluar_agenda_prop sipas_internal_agenda_penyetuju_list' }
    ],

    init: function(application) {
        this.control({
            'sipas_internal_keluar_agenda_prop sipas_internal_agenda_penyetuju_list': {
