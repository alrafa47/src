Ext.define('SIPAS.controller.Sipas.media.Prop', {
    ...
    refs : [
        { ref: 'mainview',  selector: 'sipas_media_prop' },
        { ref: 'form',      selector: 'sipas_media_prop > form' }
    ],
    ...
    init: function(application) {
        this.control({
            ...
            "sipas_media_prop sipas_com_button_save": {
                click: this.onButtonSave_Click
            },
            "sipas_media_prop sipas_com_button_edit": {
                click: this.onButtonEdit_Click
            },
            "sipas_media_prop sipas_com_button_delete": {
