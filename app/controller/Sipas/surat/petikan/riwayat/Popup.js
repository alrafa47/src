Ext.define('SIPAS.controller.Sipas.surat.petikan.riwayat.Popup', {
    ...
    stores: [
        'Sipas.koreksi.session.riwayat.petikan.List'
    ],

    refs: [
        { ref: 'mainview',      selector: 'sipas_surat_petikan_riwayat_popup' },
        { ref: 'form',          selector: 'sipas_surat_petikan_riwayat_popup > form' },
        { ref: 'list',          selector: 'sipas_surat_petikan_riwayat_popup #listPenerima' }
    ],

    init: function(application) {
        this.control({
            'sipas_surat_petikan_riwayat_popup': {
                afterrender: this.onMainview_AfterRender,
                close: this.onMainview_Close
            },
            'sipas_surat_petikan_riwayat_popup sipas_koreksi_session_riwayat_list': {
