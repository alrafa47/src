Ext.define('SIPAS.controller.Sipas.surat.penerima.staf.List', {
    ...
    refs :[
        { ref: 'mainview', selector: 'sipas_surat_penerima_staf_list' }
    ],
    ...
    init: function(application){
        this.control({
            'sipas_surat_penerima_staf_list': {
                rundelete: this.onMainview_RunDelete,
                runmoveup: this.onMainview_RunMoveUp,
                runmovedown: this.onMainview_RunMoveDown
            },
            // 'sipas_surat_penerima_staf_list sipas_com_button_add': {
            //     click: this.onButtonAdd_Click
            // },
            'sipas_surat_penerima_staf_list grid': {
                selectionchange: this.onGridpanel_SelectionChange
            },
            'sipas_surat_penerima_staf_list checkcolumn': {
