Ext.define("SIPAS.controller.Sipas.surat.penerima.Popup", {
  extend: "SIPAS.controller.Sipas.base.Base",

  controllers: ["Sipas.surat.penerima.List"],

  views: ["Sipas.surat.penerima.Popup"],
  ...
  refs: [
    { ref: "mainview", selector: "sipas_surat_penerima_popup" },
    { ref: "form", selector: "sipas_surat_penerima_popup form" },
    {
      ref: "grid",
      selector: "sipas_surat_penerima_popup form sipas_surat_penerima_list",
    },
  ],
  ...
  init: function (application) {
    this.control({
      sipas_surat_penerima_popup: {
        show: this.onMainview_Show,
      },
      "sipas_surat_penerima_popup sipas_surat_penerima_list sipas_com_button_add":
        {
          click: this.onButtonAdd_Click,
        },
      "sipas_surat_penerima_popup #buttonSend": {
      ...
      callback: function (selections) {
        for (var i in selections) {
          ...
          if (!find) {
            ...
            $helper.showMsg({
              message: this.getMessage("receiver_exist", {
  ...
  onButtonSend_Click: function (button, e, eOpts) {
    ...
    if (!params["user[]"].length) {
      $helper.showMsg({
        success: false,
        message: $this.getMessage("receiver_empty"),
      });
