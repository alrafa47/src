Ext.define('SIPAS.controller.Sipas.surat.libnomor.Prop', {
    ...
    refs : [
        ...
        { ref: 'comboModel',        selector: 'sipas_surat_libnomor_prop > form #comboModel' },
    ],
    ...
    onComboModel_AfterRender: function(cmp, eOpts){
        cmp.getStore().reload();
    },

    onComboModel_Change: function(cmp, newValue, oldValue, eOpts){
        var $this = this,
    ...
    onCombo_LoadAssociate: function(record, form, cmp){
        ...
        if(view.mode !== 'add'){
            if(record.get(cmp.getName()) !== null){
                cmp.setLoading(true);
                record[getterAssoc] && record[getterAssoc](function(r){
                    if(r){
                        cmp.setValue(r);
                    }
