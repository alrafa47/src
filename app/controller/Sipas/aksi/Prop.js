Ext.define('SIPAS.controller.Sipas.aksi.Prop', {
    ...
    refs : [
        { ref: 'mainview',  selector: 'sipas_aksi_prop' },
        { ref: 'form',      selector: 'sipas_aksi_prop > form' }
    ],
    ...
    init: function(application) {
        this.control({
            ...
            "sipas_aksi_prop sipas_com_button_save": {
                click: this.onButtonSave_Click
            },
            "sipas_aksi_prop sipas_com_button_edit": {
                click: this.onButtonEdit_Click
            },
            "sipas_aksi_prop sipas_com_button_delete": {
        ...
        switch(config.mode)
        {
            ...
            case 'view' :
                ...
                view = this.createView((function(c){
                    ...
                    c.requireComponents = ['[aksi_text]', '[name=aksi_keterangan]'];
