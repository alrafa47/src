Ext.define('SIPAS.controller.Sipas.perintah.Prop', {
    ...
    refs : [
        { ref: 'mainview',  selector: 'sipas_perintah_prop' },
        { ref: 'form',      selector: 'sipas_perintah_prop > form' }
    ],
    ...
    init: function(application)
    {
        this.control({
            ...
            "sipas_perintah_prop sipas_com_button_save": {
                click: this.onButtonSave_Click
            },
            "sipas_perintah_prop sipas_com_button_edit": {
                click: this.onButtonEdit_Click
            },
            "sipas_perintah_prop sipas_com_button_delete": {
        ...
        switch(config.mode)
        {
            ...
            case 'view' :
                ...
                view = this.createView((function(c){
                    ...
                    c.requireComponents = ['[name=perintah_text]', '[name=perintah_keterangan]'];
    ...
    onButtonSave_Click:function(button, e, eOpts)
    {
        var $helper = this.getApplication().Helper(),
            ...
            view = this.getMainview({form:button}),
