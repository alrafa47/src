Ext.define('SIPAS.controller.Sipas.pelaporan.report.surat.Tindaklanjut', {
    ...
    refs:[
        ...
        { ref: 'compFilter',    selector: 'sipas_pelaporan_report_surat_tindaklanjut sipas_com_reportfilter_rekap' },
        { ref: 'cmpFrame',      selector: 'sipas_pelaporan_report_surat_tindaklanjut #Iframe'},
        { ref: 'cmpUnit',       selector: 'sipas_pelaporan_report_surat_tindaklanjut combobox#comboUnit' },
        { ref: 'cmpFilter',     selector: 'sipas_pelaporan_report_surat_tindaklanjut sipas_com_reportfilter_rekap #comboFilter' }
    ],
