Ext.define('SIPAS.controller.Sipas.pelaporan.report.surat.Topurgent', {
    ...
    api: {
        'url': 'server.php/sipas/pelaporan/chart_surat_topurgent?unit={unit}&filter={filter}&value={value}&download={download}&excel={excel}&title={title}'
    },
    ...
    refs:[
        { ref: 'mainview',      selector: 'sipas_pelaporan_report_surat_topurgent' },
        { ref: 'compFilter',    selector: 'sipas_pelaporan_report_surat_topurgent sipas_com_reportfilter_rekap' },
        { ref: 'cmpFrame',      selector: 'sipas_pelaporan_report_surat_topurgent #Iframe'},
        { ref: 'cmpUnit',       selector: 'sipas_pelaporan_report_surat_topurgent combobox#comboUnit' },
        { ref: 'cmpFilter',     selector: 'sipas_pelaporan_report_surat_topurgent sipas_com_reportfilter_rekap #comboFilter' }
    ],
    ...
    init: function(application){
        this.control({
            "sipas_pelaporan_report_surat_topurgent sipas_com_reportfilter_rekap":{
                process: this.onFilter_Process
            },
            "sipas_pelaporan_report_surat_topurgent sipas_com_button_refresh":{
                click: this.onButtonRefresh_Click
            },
            "sipas_pelaporan_report_surat_topurgent sipas_com_button_print":{
                click: this.onButtonPrint_Click
            },
            "sipas_pelaporan_report_surat_topurgent sipas_com_button_download#btnDownloadPdf":{
                click: this.onButtonDownload_Click
            },
            "sipas_pelaporan_report_surat_topurgent sipas_com_button_download#btnDownloadExcel":{
