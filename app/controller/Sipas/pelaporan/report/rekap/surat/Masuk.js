Ext.define("SIPAS.controller.Sipas.pelaporan.report.rekap.surat.Masuk", {
  ...
  views: ["Sipas.pelaporan.report.rekap.surat.Masuk"],
  ...
  refs: [
    ...
    {
      ref: "toolbar",
      selector: "sipas_pelaporan_report_rekap_surat_masuk toolbar",
    },
    {
      ref: "compFilter",
      selector:
    ...
    {
      ref: "cmpFrame",
      selector: "sipas_pelaporan_report_rekap_surat_masuk #Iframe",
    },
    {
      ref: "cmpUnit",
      selector: "sipas_pelaporan_report_rekap_surat_masuk combobox#comboUnit",
    },
    {
      ref: "cmpBagian",
      selector: "sipas_pelaporan_report_rekap_surat_masuk combobox#comboBagian",
    },
    {
      ref: "cmpFilter",
      selector:
        "sipas_pelaporan_report_rekap_surat_masuk sipas_com_reportfilter#comboFilter",
    },
  ],
  ...
  init: function (application) {
    this.control({
      ...
      "sipas_pelaporan_report_rekap_surat_masuk combobox#comboUnit": {
