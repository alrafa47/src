Ext.define('SIPAS.controller.Sipas.pelaporan.eksternal.rekap.Pane', {
    ...
    api: {
        'url': 'server.php/sipas/surat/report_eksternal?unit={unit}&tipe={tipe}&filter={filter}&value={value}&download={download}'
    },
    ...
    refs:[
        { ref: 'mainview',      selector: 'sipas_pelaporan_eksternal_rekap_pane' },
        { ref: 'compFilter',    selector: 'sipas_pelaporan_eksternal_rekap_pane sipas_com_reportfilter_rekap_bulanan' },
        { ref: 'cmpFrame',      selector: 'sipas_pelaporan_eksternal_rekap_pane #Iframe'},
        { ref: 'cmpUnit',       selector: 'sipas_pelaporan_eksternal_rekap_pane combobox#comboUnit' },
        { ref: 'cmpFilter',       selector: 'sipas_pelaporan_eksternal_rekap_pane combobox#comboFilter' }
        // { ref: 'cmpTipe',       selector: 'sipas_pelaporan_eksternal_rekap_pane combobox#comboTipe' }
    ],
    ...
    init: function(application){
        this.control({
            "sipas_pelaporan_eksternal_rekap_pane sipas_com_reportfilter_rekap_bulanan":{
                process: this.onFilter_Process
            },
            "sipas_pelaporan_eksternal_rekap_pane sipas_com_button_refresh":{
                click: this.onButtonRefresh_Click
            },
            "sipas_pelaporan_eksternal_rekap_pane sipas_com_button_print":{
                click: this.onButtonPrint_Click
            },
            "sipas_pelaporan_eksternal_rekap_pane sipas_com_button_download":{
