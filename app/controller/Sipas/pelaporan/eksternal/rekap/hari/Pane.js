Ext.define('SIPAS.controller.Sipas.pelaporan.eksternal.rekap.hari.Pane', {
    ...
    api: {
        'url': 'server.php/sipas/pelaporan/chart_eksternal_harian?unit={unit}&filter={filter}&value={value}&download={download}'
    },
    ...
    refs:[
        { ref: 'mainview',      selector: 'sipas_pelaporan_eksternal_rekap_hari_pane' },
        { ref: 'compFilter',    selector: 'sipas_pelaporan_eksternal_rekap_hari_pane sipas_com_reportfilter' },
        { ref: 'cmpFrame',      selector: 'sipas_pelaporan_eksternal_rekap_hari_pane #Iframe'},
        { ref: 'cmpUnit',       selector: 'sipas_pelaporan_eksternal_rekap_hari_pane combobox#comboUnit' },
        { ref: 'cmpFilter',     selector: 'sipas_pelaporan_eksternal_rekap_hari_pane sipas_com_reportfilter #comboFilter' }
    ],
    ...
    init: function(application){
        this.control({
            "sipas_pelaporan_eksternal_rekap_hari_pane sipas_com_reportfilter":{
                process: this.onFilter_Process
            },
            "sipas_pelaporan_eksternal_rekap_hari_pane sipas_com_button_refresh":{
                click: this.onButtonRefresh_Click
            },
            "sipas_pelaporan_eksternal_rekap_hari_pane sipas_com_button_print":{
                click: this.onButtonPrint_Click
            },
            "sipas_pelaporan_eksternal_rekap_hari_pane sipas_com_button_download":{
    ...
    onButtonDownload_Click: function(button, e, eOpts) {
        var view = this.getMainview({from:button}),
            ...
            url = this.getApi('url', {
                ...
                unit: (Ext.isEmpty(unit) ? '' : unit),
                value: this.getCmpFilter().getValue() == 'daterange' ? filterContainer.getValue().join('|') : filterContainer.getValue(),
                download: 1
            });
