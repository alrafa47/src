Ext.define(
  "SIPAS.controller.Sipas.pelaporan.eksternal.keluar.retensi.semua.Pane",
  {
    ...
    views: ["Sipas.pelaporan.eksternal.keluar.retensi.semua.Pane"],
    ...
    refs: [
      {
        ref: "mainview",
        selector: "sipas_pelaporan_eksternal_keluar_retensi_semua_pane",
      },
      {
        ref: "compFilter",
        selector:
      ...
      {
        ref: "cmpFrame",
        selector: "sipas_pelaporan_eksternal_keluar_retensi_semua_pane #Iframe",
      },
      {
        ref: "cmpUnit",
        selector:
          "sipas_pelaporan_eksternal_keluar_retensi_semua_pane combobox#comboUnit",
      },
    ],
