Ext.define("SIPAS.controller.Sipas.pelaporan.eksternal.keluar.retensi.Pane", {
  ...
  views: ["Sipas.pelaporan.eksternal.keluar.retensi.Pane"],

  stores: ["Sipas.unit.Combo"],

  api: {
    url: "server.php/sipas/surat_keluar/report_retensi?unit={unit}&bagian={bagian}&filter={filter}&value={value}&download={download}&excel={excel}&title={title}",
  },
  ...
  refs: [
    {
      ref: "mainview",
      selector: "sipas_pelaporan_eksternal_keluar_retensi_pane",
    },
    {
      ref: "compFilter",
      selector:
    ...
    {
      ref: "cmpFrame",
      selector: "sipas_pelaporan_eksternal_keluar_retensi_pane #Iframe",
    },
    {
      ref: "cmpUnit",
      selector:
        "sipas_pelaporan_eksternal_keluar_retensi_pane combobox#comboUnit",
    },
    {
      ref: "cmpBagian",
      selector:
        "sipas_pelaporan_eksternal_keluar_retensi_pane combobox#comboBagian",
    },
  ],
