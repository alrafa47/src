Ext.define('SIPAS.controller.Sipas.pelaporan.eksternal.keluar.backdate.Pane', {
    ...
    api: {
        'url': 'server.php/sipas/surat_keluar/report_backdate?unit={unit}&filter={filter}&value={value}&download={download}&excel={excel}&title={title}'
    },
    ...
    refs:[
        { ref: 'mainview',      selector: 'sipas_pelaporan_eksternal_keluar_backdate_pane' },
        { ref: 'compFilter',    selector: 'sipas_pelaporan_eksternal_keluar_backdate_pane sipas_com_reportfilter_rekap' },
        { ref: 'cmpFrame',      selector: 'sipas_pelaporan_eksternal_keluar_backdate_pane #Iframe'},
        { ref: 'cmpUnit',       selector: 'sipas_pelaporan_eksternal_keluar_backdate_pane combobox#comboUnit' }
    ],
    ...
    init: function(application){
        this.control({
            "sipas_pelaporan_eksternal_keluar_backdate_pane":{
                show: this.onMainview_Show
            },
            "sipas_pelaporan_eksternal_keluar_backdate_pane sipas_com_reportfilter_rekap":{
                process: this.onFilter_Process
            },
            "sipas_pelaporan_eksternal_keluar_backdate_pane sipas_com_button_refresh":{
                click: this.onButtonRefresh_Click
            },
            "sipas_pelaporan_eksternal_keluar_backdate_pane sipas_com_button_print":{
                click: this.onButtonPrint_Click
            },
            "sipas_pelaporan_eksternal_keluar_backdate_pane sipas_com_button_download#btnDownloadPdf":{
                click: this.onButtonDownload_Click
            },
            "sipas_pelaporan_eksternal_keluar_backdate_pane sipas_com_button_download#btnDownloadExcel":{
