Ext.define(
  "SIPAS.controller.Sipas.pelaporan.eksternal.keluar.aktif.semua.Pane",
  {
    ...
    views: ["Sipas.pelaporan.eksternal.keluar.aktif.semua.Pane"],
    ...
    refs: [
      {
        ref: "mainview",
        selector: "sipas_pelaporan_eksternal_keluar_aktif_semua_pane",
      },
      {
        ref: "compFilter",
        selector:
      ...
      {
        ref: "cmpFrame",
        selector: "sipas_pelaporan_eksternal_keluar_aktif_semua_pane #Iframe",
      },
      {
        ref: "cmpUnit",
        selector:
