Ext.define('SIPAS.controller.Sipas.pelaporan.eksternal.masuk.rekap.Pane', {
    ...
    api: {
        'url': 'server.php/sipas/surat_masuk/report_rekap?unit={unit}&filter={filter}&value={value}&download={download}&excel={excel}&title={title}'
    },
    ...
    refs:[
        ...
        { ref: 'compFilter',    selector: 'sipas_pelaporan_eksternal_masuk_rekap_pane sipas_com_reportfilter' },
        { ref: 'cmpFrame',      selector: 'sipas_pelaporan_eksternal_masuk_rekap_pane #Iframe'},
        { ref: 'cmpUnit',       selector: 'sipas_pelaporan_eksternal_masuk_rekap_pane combobox#comboUnit' }
    ],
