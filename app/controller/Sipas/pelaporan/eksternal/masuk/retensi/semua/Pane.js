Ext.define('SIPAS.controller.Sipas.pelaporan.eksternal.masuk.retensi.semua.Pane', {
    ...
    refs:[
        { ref: 'mainview',      selector: 'sipas_pelaporan_eksternal_masuk_retensi_semua_pane' },
        { ref: 'compFilter',    selector: 'sipas_pelaporan_eksternal_masuk_retensi_semua_pane sipas_com_reportfilter' },
        { ref: 'cmpFrame',      selector: 'sipas_pelaporan_eksternal_masuk_retensi_semua_pane #Iframe'},
        { ref: 'cmpUnit',       selector: 'sipas_pelaporan_eksternal_masuk_retensi_semua_pane combobox#comboUnit' }
    ],
    ...
    init: function(application){
        this.control({
            "sipas_pelaporan_eksternal_masuk_retensi_semua_pane ":{
                show: this.onMainview_Show
            },
            "sipas_pelaporan_eksternal_masuk_retensi_semua_pane sipas_com_reportfilter":{
                process: this.onFilter_Process
            },
            "sipas_pelaporan_eksternal_masuk_retensi_semua_pane sipas_com_button_refresh":{
                click: this.onButtonRefresh_Click
            },
            "sipas_pelaporan_eksternal_masuk_retensi_semua_pane sipas_com_button_print":{
                click: this.onButtonPrint_Click
            },
            "sipas_pelaporan_eksternal_masuk_retensi_semua_pane sipas_com_button_download#btnDownloadPdf":{
                click: this.onButtonDownload_Click
            },
            "sipas_pelaporan_eksternal_masuk_retensi_semua_pane sipas_com_button_download#btnDownloadExcel":{
