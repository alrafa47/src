Ext.define(
  "SIPAS.controller.Sipas.pelaporan.eksternal.masuk.retensi.semua.Pane",
  {
    ...
    views: ["Sipas.pelaporan.eksternal.masuk.retensi.semua.Pane"],
    ...
    refs: [
      {
        ref: "mainview",
        selector: "sipas_pelaporan_eksternal_masuk_retensi_semua_pane",
      },
      {
        ref: "compFilter",
        selector:
      ...
      {
        ref: "cmpFrame",
        selector: "sipas_pelaporan_eksternal_masuk_retensi_semua_pane #Iframe",
      },
      {
        ref: "cmpUnit",
        selector:
          "sipas_pelaporan_eksternal_masuk_retensi_semua_pane combobox#comboUnit",
      },
      {
        ref: "cmpBagian",
        selector:
          "sipas_pelaporan_eksternal_masuk_retensi_semua_pane combobox#comboBagian",
      },
    ],
