Ext.define('SIPAS.controller.Sipas.pelaporan.eksternal.masuk.blmdistribusi.semua.Pane', {
    ...
    refs:[
        { ref: 'mainview',      selector: 'sipas_pelaporan_eksternal_masuk_blmdistribusi_semua_pane' },
        { ref: 'compFilter',    selector: 'sipas_pelaporan_eksternal_masuk_blmdistribusi_semua_pane sipas_com_reportfilter' },
        { ref: 'cmpFrame',      selector: 'sipas_pelaporan_eksternal_masuk_blmdistribusi_semua_pane #Iframe'},
        { ref: 'cmpUnit',       selector: 'sipas_pelaporan_eksternal_masuk_blmdistribusi_semua_pane combobox#comboUnit' }
    ],
