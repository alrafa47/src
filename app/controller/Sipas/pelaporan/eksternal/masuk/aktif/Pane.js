Ext.define('SIPAS.controller.Sipas.pelaporan.eksternal.masuk.aktif.Pane', {
    ...
    refs:[
        ...
        { ref: 'compFilter',    selector: 'sipas_pelaporan_eksternal_masuk_aktif_pane sipas_com_reportfilter' },
        { ref: 'cmpFrame',      selector: 'sipas_pelaporan_eksternal_masuk_aktif_pane #Iframe'},
        { ref: 'cmpUnit',       selector: 'sipas_pelaporan_eksternal_masuk_aktif_pane combobox#comboUnit' }
    ],
