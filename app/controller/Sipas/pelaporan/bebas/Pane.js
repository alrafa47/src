Ext.define('SIPAS.controller.Sipas.pelaporan.bebas.Pane', {
    ...
    api: {
        'url': 'server.php/sipas/arsip/report?unit={unit}&filter={filter}&value={value}&download={download}&excel={excel}&title={title}'
    },
    ...
    refs:[
        ...
        { ref: 'compFilter',    selector: 'sipas_pelaporan_bebas_pane sipas_com_reportfilter' },
        { ref: 'cmpFrame',      selector: 'sipas_pelaporan_bebas_pane #Iframe'},
        { ref: 'cmpUnit',       selector: 'sipas_pelaporan_bebas_pane combobox#comboUnit' }
    ],
