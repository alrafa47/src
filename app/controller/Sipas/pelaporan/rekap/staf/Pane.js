Ext.define("SIPAS.controller.Sipas.pelaporan.rekap.staf.Pane", {
  ...
  views: ["Sipas.pelaporan.rekap.staf.Pane"],
  ...
  refs: [
    ...
    {
      ref: "compFilter",
      selector: "sipas_pelaporan_rekap_staf_pane sipas_com_reportfilter_rekap",
    },
    { ref: "cmpFrame", selector: "sipas_pelaporan_rekap_staf_pane #Iframe" },
    {
      ref: "cmpUnit",
      selector: "sipas_pelaporan_rekap_staf_pane combobox#comboUnit",
    },
    {
      ref: "cmpFilter",
      selector:
        "sipas_pelaporan_rekap_staf_pane sipas_com_reportfilter_rekap #comboFilter",
    },
  ],
  ...
  init: function (application) {
    this.control({
      ...
      "sipas_pelaporan_rekap_staf_pane combobox#comboUnit": {
  ...
  onButtonDownload_Click: function (button, e, eOpts) {
    var view = this.getMainview({ from: button }),
      ...
      url = this.getApi("url", {
        ...
        unit: Ext.isEmpty(unit) ? "" : unit,
        value:
          filterContainer.getValue() == "daterange"
            ? filterContainer.getValue().join("|")
            : filterContainer.getValue(),
        download: 1,
        title: btoa(view.title),
