Ext.define("SIPAS.controller.Sipas.pelaporan.rekap.unit.jumlah.Pane", {
  ...
  views: ["Sipas.pelaporan.rekap.unit.jumlah.Pane"],
  ...
  refs: [
    ...
    {
      ref: "cmpFrame",
      selector: "sipas_pelaporan_rekap_unit_jumlah_pane #Iframe",
    },
    {
      ref: "cmpUnit",
      selector: "sipas_pelaporan_rekap_unit_jumlah_pane combobox#comboUnit",
    },
