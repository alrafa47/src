Ext.define('SIPAS.controller.Sipas.pelaporan.internal.rating.pengirim.Pane', {
    ...
    api: {
        'url': 'server.php/sipas/surat_ulasan/report_pengirim?unit={unit}&filter={filter}&value={value}&download={download}&excel={excel}&title={title}'
    },
    ...
    refs:[
        { ref: 'mainview',      selector: 'sipas_pelaporan_internal_rating_pengirim_pane' },
        { ref: 'compFilter',    selector: 'sipas_pelaporan_internal_rating_pengirim_pane sipas_com_reportfilter' },
        { ref: 'cmpFrame',      selector: 'sipas_pelaporan_internal_rating_pengirim_pane #Iframe'},
        { ref: 'cmpUnit',       selector: 'sipas_pelaporan_internal_rating_pengirim_pane combobox#comboUnit' }
    ],
    ...
    init: function(application){
        this.control({
            "sipas_pelaporan_internal_rating_pengirim_pane sipas_com_reportfilter":{
                process: this.onFilter_Process
            },
            "sipas_pelaporan_internal_rating_pengirim_pane sipas_com_button_refresh":{
                click: this.onButtonRefresh_Click
            },
            "sipas_pelaporan_internal_rating_pengirim_pane sipas_com_button_print":{
                click: this.onButtonPrint_Click
            },
            "sipas_pelaporan_internal_rating_pengirim_pane sipas_com_button_download#btnDownloadPdf":{
                click: this.onButtonDownload_Click
            },
            "sipas_pelaporan_internal_rating_pengirim_pane sipas_com_button_download#btnDownloadExcel":{
