Ext.define('SIPAS.controller.Sipas.pelaporan.internal.keluar.retensi.Pane', {
    ...
    refs:[
        { ref: 'mainview',      selector: 'sipas_pelaporan_internal_keluar_retensi_pane' },
        { ref: 'compFilter',    selector: 'sipas_pelaporan_internal_keluar_retensi_pane sipas_com_reportfilter_internal' },
        { ref: 'cmpFrame',      selector: 'sipas_pelaporan_internal_keluar_retensi_pane #Iframe'},
        { ref: 'cmpUnit',       selector: 'sipas_pelaporan_internal_keluar_retensi_pane combobox#comboUnit' },
        { ref: 'cmpStaf',       selector: 'sipas_pelaporan_internal_keluar_retensi_pane combobox#comboStaf' },
        { ref: 'cmpFilter',     selector: 'sipas_pelaporan_internal_keluar_retensi_pane sipas_com_reportfilter_internal #comboFilter' },
        { ref: 'cmpTipe',       selector: 'sipas_pelaporan_internal_keluar_retensi_pane sipas_com_reportfilter_internal #comboTipeInternal' }
    ],
    ...
    init: function(application){
        this.control({
            "sipas_pelaporan_internal_keluar_retensi_pane":{
                show: this.onMainview_Show
            },
            "sipas_pelaporan_internal_keluar_retensi_pane sipas_com_reportfilter_internal":{
                process: this.onFilter_Process
            },
            "sipas_pelaporan_internal_keluar_retensi_pane sipas_com_button_refresh":{
                click: this.onButtonRefresh_Click
            },
            "sipas_pelaporan_internal_keluar_retensi_pane sipas_com_button_print":{
                click: this.onButtonPrint_Click
            },
            "sipas_pelaporan_internal_keluar_retensi_pane sipas_com_button_download#btnDownloadPdf":{
                click: this.onButtonDownload_Click
            },
            "sipas_pelaporan_internal_keluar_retensi_pane sipas_com_button_download#btnDownloadExcel":{
