Ext.define('SIPAS.controller.Sipas.pelaporan.internal.keluar.aktif.Pane', {
    ...
    api: {
        'url': 'server.php/sipas/surat_ikeluar/internal_report?tipe={tipe}&unit={unit}&staf={staf}&internal=Internal&filter={filter}&value={value}&download={download}&excel={excel}&title={title}'
    },
    ...
    refs:[
        ...
        { ref: 'compFilter',    selector: 'sipas_pelaporan_internal_keluar_aktif_pane sipas_com_reportfilter_internal' },
        { ref: 'cmpFrame',      selector: 'sipas_pelaporan_internal_keluar_aktif_pane #Iframe'},
        { ref: 'cmpUnit',       selector: 'sipas_pelaporan_internal_keluar_aktif_pane combobox#comboUnit' },
        { ref: 'cmpStaf',       selector: 'sipas_pelaporan_internal_keluar_aktif_pane combobox#comboStaf' },
        { ref: 'cmpFilter',     selector: 'sipas_pelaporan_internal_keluar_aktif_pane sipas_com_reportfilter_internal #comboFilter' },
        { ref: 'cmpTipe',       selector: 'sipas_pelaporan_internal_keluar_aktif_pane sipas_com_reportfilter_internal #comboTipeInternal' }
    ],
