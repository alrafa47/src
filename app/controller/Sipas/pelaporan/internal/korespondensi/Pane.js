Ext.define('SIPAS.controller.Sipas.pelaporan.internal.korespondensi.Pane', {
    ...
    api: {
        'url':          'server.php/sipas/korespondensi/report/all?instansi={instansi}&perihal={perihal}&internal=internal&download={download}&excel={excel}',
    ...
    refs:[
        { ref: 'mainview',      selector: 'sipas_pelaporan_internal_korespondensi_pane' },
        { ref: 'compFilter',    selector: 'sipas_pelaporan_internal_korespondensi_pane sipas_com_reportfilter_korespondensi_filter' },
        { ref: 'comboInstansi', selector: 'sipas_pelaporan_internal_korespondensi_pane sipas_com_reportfilter_korespondensi_filter #comboInstansi' },
        { ref: 'comboFilter',   selector: 'sipas_pelaporan_internal_korespondensi_pane sipas_com_reportfilter_korespondensi_filter #comboFilter' }
    ],
    ...
    init: function(application){
        this.control({
            "sipas_pelaporan_internal_korespondensi_pane sipas_com_reportfilter_korespondensi_filter #buttonProcess":{
                click: this.onFilter_Process
            },
            "sipas_pelaporan_internal_korespondensi_pane sipas_com_button_refresh":{
                click: this.onButtonRefresh_Click
            },
            "sipas_pelaporan_internal_korespondensi_pane sipas_com_button_print":{
                click: this.onButtonPrint_Click
            },
            "sipas_pelaporan_internal_korespondensi_pane sipas_com_button_download#btnDownloadPdf":{
                click: this.onButtonDownload_Click
            },
            "sipas_pelaporan_internal_korespondensi_pane sipas_com_button_download#btnDownloadExcel":{
                click: this.onButtonDownloadExcel_Click
            },
            "sipas_pelaporan_internal_korespondensi_pane sipas_com_reportfilter_korespondensi_filter #comboInstansi":{
