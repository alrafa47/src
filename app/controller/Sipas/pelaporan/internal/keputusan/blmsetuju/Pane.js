Ext.define(
  "SIPAS.controller.Sipas.pelaporan.internal.keputusan.blmsetuju.Pane",
  {
    ...
    views: ["Sipas.pelaporan.internal.keputusan.blmsetuju.Pane"],

    stores: ["Sipas.unit.Combo"],

    api: {
      url: "server.php/sipas/surat_keputusan/internal_report_blmsetuju?tipesk={tipesk}&jenissub={jenissub}&unit={unit}&bagian={bagian}&internal=Internal&filter={filter}&value={value}&download={download}&excel={excel}&title={title}",
    },
    ...
    refs: [
      {
        ref: "mainview",
        selector: "sipas_pelaporan_internal_keputusan_blmsetuju_pane",
      },
      {
        ref: "compFilter",
        selector:
      ...
      {
        ref: "cmpFrame",
        selector: "sipas_pelaporan_internal_keputusan_blmsetuju_pane #Iframe",
      },
      {
        ref: "cmpUnit",
        selector:
          "sipas_pelaporan_internal_keputusan_blmsetuju_pane combobox#comboUnit",
      },
      {
        ref: "cmpBagianUnit",
        selector:
          "sipas_pelaporan_internal_keputusan_blmsetuju_pane combobox#comboBagian",
      },
      {
        ref: "cmpFilter",
        selector:
          "sipas_pelaporan_internal_keputusan_blmsetuju_pane sipas_com_reportfilter_keputusan #comboFilter",
      },
      {
        ref: "cmpTipeSK",
        selector:
          "sipas_pelaporan_internal_keputusan_blmsetuju_pane sipas_com_reportfilter_keputusan #comboTipeSK",
      },
      {
        ref: "cmpJenisSub",
        selector:
          "sipas_pelaporan_internal_keputusan_blmsetuju_pane sipas_com_reportfilter_keputusan #comboJenisSub",
      },
    ],
