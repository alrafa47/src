Ext.define(
  "SIPAS.controller.Sipas.pelaporan.internal.keputusan.retensi.semua.Pane",
  {
    ...
    views: ["Sipas.pelaporan.internal.keputusan.retensi.semua.Pane"],
    ...
    refs: [
      {
        ref: "mainview",
        selector: "sipas_pelaporan_internal_keputusan_retensi_semua_pane",
      },
      {
        ref: "compFilter",
        selector:
      ...
      },
      {
        ref: "cmpFrame",
        selector:
          "sipas_pelaporan_internal_keputusan_retensi_semua_pane #Iframe",
      },
      {
        ref: "cmpUnit",
        selector:
          "sipas_pelaporan_internal_keputusan_retensi_semua_pane combobox#comboUnit",
      },
      {
        ref: "cmpFilter",
        selector:
          "sipas_pelaporan_internal_keputusan_retensi_semua_pane sipas_com_reportfilter_keputusan #comboFilter",
      },
      {
        ref: "cmpTipeSK",
        selector:
          "sipas_pelaporan_internal_keputusan_retensi_semua_pane sipas_com_reportfilter_keputusan #comboTipeSK",
      },
      {
        ref: "cmpJenisSub",
        selector:
          "sipas_pelaporan_internal_keputusan_retensi_semua_pane sipas_com_reportfilter_keputusan #comboJenisSub",
      },
    ],
