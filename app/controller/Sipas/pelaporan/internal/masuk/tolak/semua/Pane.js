Ext.define('SIPAS.controller.Sipas.pelaporan.internal.masuk.tolak.semua.Pane', {
    ...
    refs:[
        { ref: 'mainview',      selector: 'sipas_pelaporan_internal_masuk_tolak_semua_pane' },
        { ref: 'compFilter',    selector: 'sipas_pelaporan_internal_masuk_tolak_semua_pane sipas_com_reportfilter_internal' },
        { ref: 'cmpFrame',      selector: 'sipas_pelaporan_internal_masuk_tolak_semua_pane #Iframe'},
        { ref: 'cmpUnit',       selector: 'sipas_pelaporan_internal_masuk_tolak_semua_pane combobox#comboUnit' },
        { ref: 'cmpStaf',       selector: 'sipas_pelaporan_internal_masuk_tolak_semua_pane combobox#comboStaf' },
        { ref: 'cmpFilter',     selector: 'sipas_pelaporan_internal_masuk_tolak_semua_pane sipas_com_reportfilter_internal #comboFilter' },
        { ref: 'cmpTipe',       selector: 'sipas_pelaporan_internal_masuk_tolak_semua_pane sipas_com_reportfilter_internal #comboTipeInternal' }
    ],
