Ext.define("SIPAS.controller.Sipas.pelaporan.internal.masuk.aktif.semua.Pane", {
  ...
  views: ["Sipas.pelaporan.internal.masuk.aktif.semua.Pane"],
  ...
  refs: [
    {
      ref: "mainview",
      selector: "sipas_pelaporan_internal_masuk_aktif_semua_pane",
    },
    {
      ref: "compFilter",
      selector:
    ...
    {
      ref: "cmpFrame",
      selector: "sipas_pelaporan_internal_masuk_aktif_semua_pane #Iframe",
    },
    {
      ref: "cmpUnit",
      selector:
        "sipas_pelaporan_internal_masuk_aktif_semua_pane combobox#comboUnit",
    },
    {
      ref: "cmpBagian",
      selector:
        "sipas_pelaporan_internal_masuk_aktif_semua_pane combobox#comboBagian",
    },
    {
      ref: "cmpStaf",
      selector:
        "sipas_pelaporan_internal_masuk_aktif_semua_pane combobox#comboStaf",
    },
    {
      ref: "cmpFilter",
      selector:
        "sipas_pelaporan_internal_masuk_aktif_semua_pane sipas_com_reportfilter_internal #comboFilter",
    },
    {
      ref: "cmpTipe",
      selector:
        "sipas_pelaporan_internal_masuk_aktif_semua_pane sipas_com_reportfilter_internal #comboTipeInternal",
    },
  ],
