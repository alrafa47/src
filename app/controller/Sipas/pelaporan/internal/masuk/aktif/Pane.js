Ext.define("SIPAS.controller.Sipas.pelaporan.internal.masuk.aktif.Pane", {
  extend: "SIPAS.controller.Sipas.base.Base",

  views: ["Sipas.pelaporan.internal.masuk.aktif.Pane"],

  stores: ["Sipas.unit.Combo"],

  api: {
    url: "server.php/sipas/surat_imasuk/internal_report?tipe={tipe}&unit={unit}&bagian={bagian}&internal=Internal&filter={filter}&value={value}&download={download}&excel={excel}&title={title}",
  },
  ...
  refs: [
    { ref: "mainview", selector: "sipas_pelaporan_internal_masuk_aktif_pane" },
    {
      ref: "compFilter",
      selector:
        "sipas_pelaporan_internal_masuk_aktif_pane sipas_com_reportfilter_internal",
    },
    {
      ref: "cmpFrame",
      selector: "sipas_pelaporan_internal_masuk_aktif_pane #Iframe",
    },
    {
      ref: "cmpUnit",
      selector: "sipas_pelaporan_internal_masuk_aktif_pane combobox#comboUnit",
    },
    {
      ref: "cmpBagian",
      selector:
        "sipas_pelaporan_internal_masuk_aktif_pane combobox#comboBagian",
    },
    {
      ref: "cmpStaf",
      selector: "sipas_pelaporan_internal_masuk_aktif_pane combobox#comboStaf",
    },
    {
      ref: "cmpFilter",
      selector:
        "sipas_pelaporan_internal_masuk_aktif_pane sipas_com_reportfilter_internal #comboFilter",
    },
    {
      ref: "cmpTipe",
      selector:
        "sipas_pelaporan_internal_masuk_aktif_pane sipas_com_reportfilter_internal #comboTipeInternal",
    },
  ],
  ...
  init: function (application) {
    this.control({
      sipas_pelaporan_internal_masuk_aktif_pane: {
      ...
      "sipas_pelaporan_internal_masuk_aktif_pane sipas_com_button_refresh": {
        click: this.onButtonRefresh_Click,
      },
      "sipas_pelaporan_internal_masuk_aktif_pane sipas_com_button_print": {
        click: this.onButtonPrint_Click,
      },
      "sipas_pelaporan_internal_masuk_aktif_pane sipas_com_button_download#btnDownloadPdf":
        {
          click: this.onButtonDownload_Click,
        },
      "sipas_pelaporan_internal_masuk_aktif_pane sipas_com_button_download#btnDownloadExcel":
        {
          click: this.onButtonDownloadExcel_Click,
        },
      "sipas_pelaporan_internal_masuk_aktif_pane combobox#comboUnit": {
