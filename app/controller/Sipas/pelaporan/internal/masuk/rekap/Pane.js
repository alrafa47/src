Ext.define("SIPAS.controller.Sipas.pelaporan.internal.masuk.rekap.Pane", {
  ...
  views: ["Sipas.pelaporan.internal.masuk.rekap.Pane"],

  stores: ["Sipas.unit.Combo"],

  api: {
    url: "server.php/sipas/surat_imasuk/report_rekap?tipe={tipe}&unit={unit}&bagian={bagian}&internal=Internal&filter={filter}&value={value}&download={download}&excel={excel}&title={title}",
  },
  ...
  refs: [
    ...
    {
      ref: "cmpFrame",
      selector: "sipas_pelaporan_internal_masuk_rekap_pane #Iframe",
    },
    {
      ref: "cmpUnit",
      selector: "sipas_pelaporan_internal_masuk_rekap_pane combobox#comboUnit",
    },
    {
      ref: "cmpBagian",
      selector:
        "sipas_pelaporan_internal_masuk_rekap_pane combobox#comboBagian",
    },
    {
      ref: "cmpStaf",
      selector: "sipas_pelaporan_internal_masuk_rekap_pane combobox#comboStaf",
    },
    {
      ref: "cmpFilter",
      selector:
        "sipas_pelaporan_internal_masuk_rekap_pane sipas_com_reportfilter_internal #comboFilter",
    },
    {
      ref: "cmpTipe",
      selector:
        "sipas_pelaporan_internal_masuk_rekap_pane sipas_com_reportfilter_internal #comboTipeInternal",
    },
  ],
