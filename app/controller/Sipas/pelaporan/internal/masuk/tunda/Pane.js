Ext.define('SIPAS.controller.Sipas.pelaporan.internal.masuk.tunda.Pane', {
    ...
    api: {
        'url': 'server.php/sipas/surat_imasuk/internal_report_tunda?tipe={tipe}&unit={unit}&internal=Internal&filter={filter}&value={value}&download={download}&excel={excel}&title={title}'
    },
    ...
    refs:[
        ...
        { ref: 'compFilter',    selector: 'sipas_pelaporan_internal_masuk_tunda_pane sipas_com_reportfilter_internal' },
        { ref: 'cmpFrame',      selector: 'sipas_pelaporan_internal_masuk_tunda_pane #Iframe'},
        { ref: 'cmpUnit',       selector: 'sipas_pelaporan_internal_masuk_tunda_pane combobox#comboUnit' },
        { ref: 'cmpStaf',       selector: 'sipas_pelaporan_internal_masuk_tunda_pane combobox#comboStaf' },
        { ref: 'cmpFilter',     selector: 'sipas_pelaporan_internal_masuk_tunda_pane sipas_com_reportfilter_internal #comboFilter' },
        { ref: 'cmpTipe',       selector: 'sipas_pelaporan_internal_masuk_tunda_pane sipas_com_reportfilter_internal #comboTipeInternal' }
    ],
