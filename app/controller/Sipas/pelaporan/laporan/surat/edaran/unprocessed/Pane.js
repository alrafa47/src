Ext.define('SIPAS.controller.Sipas.pelaporan.laporan.surat.edaran.unprocessed.Pane', {
    ...
    refs:[
        { ref: 'mainview',      selector: 'sipas_pelaporan_laporan_surat_edaran_unprocessed_pane' },
        { ref: 'compFilter',    selector: 'sipas_pelaporan_laporan_surat_edaran_unprocessed_pane sipas_com_reportfilter' },
        { ref: 'cmpFrame',      selector: 'sipas_pelaporan_laporan_surat_edaran_unprocessed_pane #Iframe'},
        { ref: 'cmpUnit',       selector: 'sipas_pelaporan_laporan_surat_edaran_unprocessed_pane combobox#comboUnit' }
    ],
    ...
    init: function(application){
        this.control({
            "sipas_pelaporan_laporan_surat_edaran_unprocessed_pane sipas_com_reportfilter":{
                process: this.onFilter_Process
            },
            "sipas_pelaporan_laporan_surat_edaran_unprocessed_pane sipas_com_button_refresh":{
                click: this.onButtonRefresh_Click
            },
            "sipas_pelaporan_laporan_surat_edaran_unprocessed_pane sipas_com_button_print":{
                click: this.onButtonPrint_Click
            },
            "sipas_pelaporan_laporan_surat_edaran_unprocessed_pane sipas_com_button_download":{
