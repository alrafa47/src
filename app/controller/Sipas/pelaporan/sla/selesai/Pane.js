Ext.define('SIPAS.controller.Sipas.pelaporan.sla.selesai.Pane', {
    ...
    api: {
        'url': 'server.php/sipas/pelaporan_sla/report_sla_selesai?unit={unit}&filter={filter}&value={value}&download={download}&excel={excel}'
    },
    ...
    refs:[
        { ref: 'mainview',      selector: 'sipas_pelaporan_sla_selesai_pane' },
        { ref: 'compFilter',    selector: 'sipas_pelaporan_sla_selesai_pane sipas_com_reportfilter' },
        { ref: 'cmpFrame',      selector: 'sipas_pelaporan_sla_selesai_pane #Iframe'},
        { ref: 'cmpUnit',       selector: 'sipas_pelaporan_sla_selesai_pane combobox#comboUnit' }
    ],
    ...
    init: function(application){
        this.control({
            "sipas_pelaporan_sla_selesai_pane sipas_com_reportfilter":{
                process: this.onFilter_Process
            },
            "sipas_pelaporan_sla_selesai_pane sipas_com_button_refresh":{
                click: this.onButtonRefresh_Click
            },
            "sipas_pelaporan_sla_selesai_pane sipas_com_button_print":{
                click: this.onButtonPrint_Click
            },
            "sipas_pelaporan_sla_selesai_pane sipas_com_button_download#btnDownloadPdf":{
                click: this.onButtonDownload_Click
            },
            "sipas_pelaporan_sla_selesai_pane sipas_com_button_download#btnDownloadExcel":{
