Ext.define('SIPAS.controller.Sipas.unit.Prop', {
    ...
    refs : [
        ...
        { ref: 'containerParent',   selector: 'sipas_unit_prop > form > container#containerParent' },
        { ref: 'comboParent',       selector: 'sipas_unit_prop > form > container#containerParent triggerfield#comboParent' },
        { ref: 'comboInduk',        selector: 'sipas_unit_prop > form > container#containerParent #comboParent' }
    ],
        ...
        switch(config.mode)
        {
            ...
            case 'view' :
                ...
                view = $this.createView((function(c){
                    ...
                    c.requireComponents = ['[name=unit_kode]', '[name=unit_kode_rubrik]', '[name=unit_nama]'];
                    c.readonlyComponents.push('#unit_pos_code');

                    if(c.mode === 'view') {
                        // c.removeComponents.push('#toolbarAction','sipas_com_button_cross');
                        c.removeComponents.push('sipas_com_button_cross', 'sipas_com_button_save');
                    }

                    if(c.mode === 'edit') {
                        c.removeComponents.push('#btnStafUnit', 'sipas_com_button_delete', 'sipas_com_button_edit', '#btnUnit');
                    }
    ...
    {
        var triggerfield = mainview.down('container#containerManager triggerfield#comboManager'),
            hiddenfield = mainview.down('container#containerManager hiddenfield#hiddenManager');
