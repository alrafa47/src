Ext.define('SIPAS.controller.Sipas.masuk.agenda.distribusi.penerima.List', {
    ...
    refs:[
        { ref: 'mainview',  selector: 'sipas_masuk_agenda_distribusi_penerima_list' }
    ],

    controllerStafLookup  : 'Sipas.staf.penerima.Lookup',
    storePenerima         : 'Sipas.masuk.agenda.distribusi.penerima.List',

    init: function(application) {
        this.control({
            'sipas_masuk_agenda_distribusi_penerima_list': {
                selectionchange: this.onGridpanel_SelectionChange,
                affterrender: this.launch,
                edit: this.onGridPenerima_Edit,
                rundelete: this.onMainview_RunDelete
            },
            'sipas_masuk_agenda_distribusi_penerima_list sipas_com_button_plus': {
                click: this.onButtonTambahPenerima_Click
            },
            'sipas_masuk_agenda_distribusi_penerima_list checkcolumn': {
    ...
    onButtonTambahPenerima_Click: function(button, e, eOpts){
        ...
        //                 storePenerima.add(r);
        //             }else{
        //                 var msg = $this.getMessage('receiver_exist',{id: r.get('staf_nama')});
        //                 $helper.showNotification(msg[0],msg[1]);
        //             }
        //         });
        //     }
