Ext.define('SIPAS.controller.Sipas.disposisi.session.penerima.jabatan.Popup', {
    ...
    refs: [
        { ref: 'mainview', selector: 'sipas_disposisi_session_penerima_jabatan_popup' },
        { ref: 'form',     selector: 'sipas_disposisi_session_penerima_jabatan_popup > form' },
        { ref: 'list',     selector: 'sipas_disposisi_session_penerima_jabatan_popup #listPenerima' }
    ],

    init: function(application) {
        this.control({
            'sipas_disposisi_session_penerima_jabatan_popup': {
                afterrender: this.onMainview_AfterRender,
                close: this.onMainview_Close
            },
            'sipas_disposisi_session_penerima_jabatan_popup #listPenerima': {
