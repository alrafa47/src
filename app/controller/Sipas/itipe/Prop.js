Ext.define('SIPAS.controller.Sipas.itipe.Prop', {
    ...
    refs : [
        { ref: 'mainview',  selector: 'sipas_itipe_prop' },
        { ref: 'form',      selector: 'sipas_itipe_prop > form' }
    ],
    ...
    // defaultModel:       'Sipas.Itipe',
    storeList:          'Sipas.itipe.semua.List',
    ...
    init: function(application) {
        this.control({
            ...
            "sipas_itipe_prop sipas_com_button_save": {
                click: this.onButtonSave_Click
            },
            "sipas_itipe_prop sipas_com_button_edit": {
                click: this.onButtonEdit_Click
            },
            "sipas_itipe_prop sipas_com_button_delete": {
        ...
        switch(config.mode)
        {
            ...
            case 'view' :
                ...
                view = $this.createView((function(c){
                    ...
                    c.requireComponents = ['[name=itipe_kode]', '[name=itipe_nama]'];
