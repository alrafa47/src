Ext.define('SIPAS.controller.Sipas.staf.tim.anggota.Form', {
    ...
    stores: [
        'Sipas.staf.tim.anggota.List',
        'Sipas.staf.tim.anggota.Combo'
    ],

    refs:[
        { ref: 'mainview',  selector: 'sipas_staf_tim_anggota_form' },
        { ref: 'grid',      selector: 'sipas_staf_tim_anggota_form grid' }
    ],
    ...
    init: function(application) {
        this.control({
            'sipas_staf_tim_anggota_form': {
                loadrecord: this.onMainview_LoadRecord,
                clearrecord: this.onMainview_ClearRecord
            },
            'sipas_staf_tim_anggota_form sipas_com_button_save': {
