Ext.define("SIPAS.controller.Sipas.staf.tim.Prop", {
  ...
  views: ["Sipas.staf.tim.Prop"],

  models: ["Sipas.staf.Tim"],
  stores: ["Sipas.staf.tim.List"],

  refs: [
    { ref: "mainview", selector: "sipas_staf_tim_prop" },
    { ref: "form", selector: "sipas_staf_tim_prop > form" },
    // { ref: "comboUnit", selector: "sipas_staf_tim_prop #comboUnit" },
  ],
  ...
  init: function (application) {
    this.control({
      ...
      "sipas_staf_tim_prop sipas_com_button_save": {
        click: this.onButtonSave_Click,
      },
      "sipas_staf_tim_prop sipas_com_button_edit": {
        click: this.onButtonEdit_Click,
      },
      "sipas_staf_tim_prop sipas_com_button_delete": {
      ...
      case "view":
        view = $this.createView(
          (function (c) {
            ...
            c.requireComponents = ["[name=staf_tim_nama]"];
