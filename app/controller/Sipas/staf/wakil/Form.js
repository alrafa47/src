Ext.define('SIPAS.controller.Sipas.staf.wakil.Form', {
    ...
    refs:[
        { ref: 'mainview',  selector: 'sipas_staf_wakil_form' },
        { ref: 'grid',      selector: 'sipas_staf_wakil_form grid' }
    ],
