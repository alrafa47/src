Ext.define('SIPAS.controller.Sipas.staf.wakil.Popup', {
    ...
    refs:[
        { ref: 'mainview',  selector: 'sipas_staf_wakil_popup' },
        { ref: 'form',      selector: 'sipas_staf_wakil_popup sipas_staf_wakil_form' },
        { ref: 'grid',      selector: 'sipas_staf_wakil_popup sipas_staf_wakil_form grid' }
    ],

    messages: {
        'message_success': ['Berhasil mengubah asisten']
    },
    ...
    init: function(application) {
        this.control({
            'sipas_staf_wakil_popup': {
                show: this.onMainview_Show
            },
            'sipas_staf_wakil_popup sipas_staf_wakil_form sipas_com_button_save': {
