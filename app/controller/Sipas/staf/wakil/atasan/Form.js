Ext.define('SIPAS.controller.Sipas.staf.wakil.atasan.Form', {
    ...
    refs:[
        { ref: 'mainview',  selector: 'sipas_staf_wakil_atasan_form' },
        { ref: 'grid',      selector: 'sipas_staf_wakil_atasan_form grid' }
    ],
