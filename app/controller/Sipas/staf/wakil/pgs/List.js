Ext.define('SIPAS.controller.Sipas.staf.wakil.pgs.List', {
    ...
    refs:[
        { ref: 'mainview', selector: 'sipas_staf_wakil_pgs_list' }
    ],

    controllerStafLookup : 'Sipas.staf.wakil.Lookup',
    storeAnggota         : 'Sipas.staf.wakil.Lookup',
    storePgs             : 'Sipas.staf.wakil.pgs.List',

    init: function(application) {
        this.control({
            'sipas_staf_wakil_pgs_list': {
            ...
            'sipas_staf_wakil_pgs_list #fieldSearch': {
                focus: this.onFieldSearch_Focus,
                select: this.onMainview_fieldSearch_Select
            },
            'sipas_staf_wakil_pgs_list #buttonManual': {
    ...
    onFieldSearch_Focus: function(cmp, eOpts){
        var $this = this,
            ...
            form = mainview.up('sipas_staf_wakil_pgs_form'),
    ...
    onMainview_AppendRecord: function(view, record){
        ...
        var $this = this,
            ...
            $helper = $app.Helper(),
            store = view.getStore(),
            form = view.up('sipas_staf_wakil_pgs_form'),
            staf_id = form.down('[name=staf_id]'),
            stafId = staf_id.getValue(),
            now = new Date();
