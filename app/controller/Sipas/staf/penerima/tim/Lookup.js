Ext.define('SIPAS.controller.Sipas.staf.penerima.tim.Lookup', {
    ...
    refs: [
        { ref: 'mainview',  selector: 'sipas_staf_penerima_tim_lookup'},
        { ref: 'grid',      selector: 'sipas_staf_penerima_tim_lookup sipas_staf_penerima_tim_anggota_list'},
        { ref: 'putin',     selector: 'sipas_staf_penerima_tim_lookup sipas_com_button_putin' }
    ],
    ...
    init: function(application) {
        this.control({
            'sipas_staf_penerima_tim_lookup': {
