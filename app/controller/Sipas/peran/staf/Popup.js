Ext.define('SIPAS.controller.Sipas.peran.staf.Popup', {
    extend: 'SIPAS.controller.Sipas.base.Prop',

    store:[
        'Sipas.peran.staf.List',
    ...
    refs:[
        { ref: 'mainview',  selector: 'sipas_peran_staf_popup' },
        { ref: 'form',      selector: 'sipas_peran_staf_popup > form' },
        { ref: 'grid',      selector: 'sipas_peran_staf_popup grid' }
    ],
