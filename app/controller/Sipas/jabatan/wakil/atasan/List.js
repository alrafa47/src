Ext.define('SIPAS.controller.Sipas.jabatan.wakil.atasan.List', {
    ...
    refs:[
        { ref: 'mainview', selector: 'sipas_jabatan_wakil_atasan_list' }
    ],
    ...
    init: function(application) {
        this.control({
            'sipas_jabatan_wakil_atasan_list': {
            ...
            'sipas_jabatan_wakil_atasan_list #fieldSearch': {
                focus: this.onFieldSearch_Focus,
                select: this.onMainview_fieldSearch_Select
            },
            'sipas_jabatan_wakil_atasan_list #buttonManual': {
    ...
    onMainview_buttonManual_Click: function(button, e, eOpts){
        var $this = this,
            ...
            record = view.record,
            jabatanId = record.get('jabatan_id'),
            batas_hirarki = $app.LocalSetting().get('use_asistensi_batas_hirarki'),
                ...
                for(var i in selections){
                    ...
                    if(!find){
                        ...
                        if ((count_before + 1) > 100){
                            ...
                            storeAnggota.add({
                                // 'jabatan_wakil_asisten': jabatanId,
