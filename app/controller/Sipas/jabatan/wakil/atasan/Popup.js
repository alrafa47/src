Ext.define('SIPAS.controller.Sipas.jabatan.wakil.atasan.Popup', {
    ...
    views: [
        'Sipas.jabatan.wakil.atasan.Popup'
    ],

    refs:[
        { ref: 'mainview',      selector: 'sipas_jabatan_wakil_atasan_popup' },
        { ref: 'form',          selector: 'sipas_jabatan_wakil_atasan_popup sipas_jabatan_wakil_atasan_form' },
        { ref: 'grid',          selector: 'sipas_jabatan_wakil_atasan_popup sipas_jabatan_wakil_atasan_form grid' },
        { ref: 'cmpStaf',       selector: 'sipas_jabatan_wakil_atasan_popup > form [name=staf_nama]' },
        { ref: 'cmpUnit',       selector: 'sipas_jabatan_wakil_atasan_popup > form [name=unit_nama]' },
        { ref: 'cmpJabatan',    selector: 'sipas_jabatan_wakil_atasan_popup > form [name=jabatan_nama]' }
    ],
    ...
    init: function(application) {
        this.control({
            'sipas_jabatan_wakil_atasan_popup': {
                show: this.onMainview_Show
            },
            'sipas_jabatan_wakil_atasan_popup sipas_jabatan_wakil_atasan_form sipas_com_button_save': {
