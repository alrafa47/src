Ext.define('SIPAS.controller.Sipas.jabatan.wakil.asisten.List', {
    ...
    messages: {
        ...
        'not_allowed': ['Peringatan','Tidak diperbolehkan']
    },

    refs:[
        { ref: 'mainview',      selector: 'sipas_jabatan_wakil_asisten_list' },
        { ref: 'fieldSearch',   selector: 'sipas_jabatan_wakil_asisten_list #fieldSearch' }
    ],
    ...
    init: function(application) {
        this.control({
            'sipas_jabatan_wakil_asisten_list': {
            ...
            'sipas_jabatan_wakil_asisten_list #fieldSearch': {
                focus: this.onFieldSearch_Focus,
                select: this.onMainview_fieldSearch_Select
            },
            'sipas_jabatan_wakil_asisten_list #buttonManual': {
    ...
    onMainview_AppendRecord: function(view, record){
        ...
        store.insert(0, {
            ...
            'jabatan_wakil_asisten': record.get('jabatan_id'),
                ...
                for(var i in selections){
                    ...
                    if(!find){
                        ...
                        if ((count_before + 1) > 100){
                            ...
                            storeAnggota.add({
                                // 'jabatan_wakil_jabatan': jabatanId,
