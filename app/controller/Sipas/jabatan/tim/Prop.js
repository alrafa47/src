Ext.define('SIPAS.controller.Sipas.jabatan.tim.Prop', {
    ...
    refs : [
        { ref: 'mainview',  selector: 'sipas_jabatan_tim_prop' },
        { ref: 'form',      selector: 'sipas_jabatan_tim_prop > form' }
    ],
    ...
    init: function(application) {
        this.control({
            'sipas_jabatan_tim_prop': {
                afterrender: this.onMainview_AfterRender,
                close: this.onMainview_Close
            },
            "sipas_jabatan_tim_prop sipas_com_button_save": {
                click: this.onButtonSave_Click
            },
            "sipas_jabatan_tim_prop sipas_com_button_edit": {
                click: this.onButtonEdit_Click
            },
            "sipas_jabatan_tim_prop sipas_com_button_delete": {
        ...
        switch(config.mode)
        {
            ...
            case 'view' :
                ...
                view = $this.createView((function(c){
                    ...
                    c.requireComponents = ['[name=jabatan_tim_nama]'];
