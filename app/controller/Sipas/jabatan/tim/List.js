Ext.define('SIPAS.controller.Sipas.jabatan.tim.List', {
    ...
    refs: [
        { ref: 'mainview', selector: 'sipas_jabatan_tim_list'}
    ],

    defaultStore: 'Sipas.jabatan.tim.List',

    controllerProperty: 'Sipas.jabatan.tim.Prop',

    init: function(application) {
        this.control({
            "sipas_jabatan_tim_list sipas_com_button_add": {
                click: this.onButtonAdd_Click
            },
            "sipas_jabatan_tim_list sipas_com_button_refresh": {
                click: this.onButtonRefresh_Click
            },
            "sipas_jabatan_tim_list": {
                selectionchange: this.onGridpanel_SelectionChange
                // itemdblclick: this.onMainview_DoubleClick
            },
            'sipas_jabatan_tim_list[clickToView=true]': {
                itemclick: this.onMainview_ClickShow
            },
            'sipas_jabatan_tim_list[dbclickToView=true]': {
