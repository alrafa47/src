Ext.define('SIPAS.controller.Sipas.jabatan.Treelist', {
    ...
    onComboStatus_Select: function(combo, selection, eOpts){
        ...
        switch(value){
            case 1:
                // store.removeAll();
                store.getProxy().url = 'server.php/sipas/jabatan/aktif/tree';
            break;
            case 2:
                // store.removeAll();
                store.getProxy().url = 'server.php/sipas/jabatan/nonaktif/tree';
            break;
            default:
                // store.removeAll();
                store.getProxy().url = 'server.php/sipas/jabatan/read/tree';
            break;
        }
