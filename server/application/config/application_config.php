...
$config['access_route'] = array(
    ...
    //account
    array('session',                                        1, array('sipas/account',
                                                                     'sipas/account/index',
                                                                     'sipas/account/wakil',
    ...
    array('session',                                        0, array('sipas/account/login/token',
                                                                     'sipas/account/login',
                                                                     ...
                                                                     'sipas/account/info/session')), /*checked-m*/

    //addon
    //akses
    array('hakakses',                                       1, array('sipas/akses',
                                                                     'sipas/akses/index',
                                                                     'sipas/akses/read')), /*checked-m*/
    ...
    array('aksi',                                           1, array('sipas/aksi',
                                                                     'sipas/aksi/index',
                                                                     'sipas/aksi/read',
                                                                     'sipas/aksi/aktif',
                                                                     'sipas/aksi/nonaktif')),/*has been checked by Luqni Maulana*/
    //akun
    ...
    array('staf',                                           1, array('sipas/akun',
                                                                     'sipas/akun/index',
                                                                     'sipas/akun/read', /*checked-m*/
                                                                     'sipas/akun/aktif', 
                                                                     'sipas/akun/nonaktif')), 
    //api
    array('api_info',                                       0, array('sipas/api',
                                                                     'sipas/api/index',
                                                                     'sipas/api/info',
                                                                     'sipas/kotak_masuk/tugassaya_admin')), /*checked-m*/
    //arsip
    ...
    array('arsip',                                          0, array('arsipbebas',
                                                                     'sipas/arsip/link')),
    array('arsip',                                          1, array('sipas/arsip',
                                                                     'sipas/arsip/index',
                                                                     'sipas/arsip/read',
                                                                     'sipas/arsip/hidup',
                                                                     'sipas/arsip/bagi',
                                                                     ...
                                                                     'sipas/arsip/generateField')),/*has been checked by Luqni Maulana*/
    //asset
    array('asset',                                          1, array('sipas/asset/css',
                                                                     'sipas/asset/img',
                                                                     'sipas/asset/js',
                                                                     ...
                                                                     'sipas/asset')),/*has been checked by Luqni Maulana*/
    //backup
    array('backup',                                         1, array('sipas/backup/create')),
    array('backup',                                         1, array('sipas/backup/update')),
    array('backup',                                         1, array('sipas/backup',
                                                                     'sipas/backup/index',
                                                                     'sipas/backup/read')), /*checked-m*/
    //bank
    array('bank',                                           1, array('sipas/bank',
                                                                     'sipas/bank/index',
                                                                     'sipas/bank/read',
                                                                     'sipas/bank/read/0', 
                                                                     'sipas/bank/read/1',
                                                                     ...
                                                                     'sipas/bank/arsip/4')),
    //beranda
    array('beranda',                                        1, array('sipas/beranda',
                                                                     'sipas/beranda/index',
                                                                     'sipas/beranda/surat_masuk',
                                                                     'sipas/beranda/suratcount',
                                                                     'sipas/beranda/suratcount/chart')),/*has been checked by Luqni Maulana*/
    //buktikirim
    ...
    array('buktikirim',                                     1, array('sipas/buktikirim',
                                                                     'sipas/buktikirim/index',
                                                                     'sipas/buktikirim/read')), /*checked-m*/
    //dasbor
    array('rekap_dashboard',                                1, array('sipas/dasbor',
                                                                     'sipas/dasbor/index',
                                                                     'sipas/dasbor/surat_masuk',
                                                                     'sipas/dasbor/surat_keluar',
                                                                     'sipas/dasbor/disposisi_masuk',
                                                                     'sipas/dasbor/chart',
                                                                     'sipas/dasbor/get_dashboard')),/*has been checked by Luqni Maulana*/
    //disposisi
    array('disposisi',                                      1, array('sipas/disposisi/create')),
    array('disposisi',                                      1, array('sipas/disposisi/update')),
    array('disposisi',                                      1, array('sipas/disposisi',
                                                                     ...
                                                                     'sipas/disposisi/next/code')), /*checked-m*/
    //disposisi_masuk
    array('disposisi',                                      1, array('sipas/disposisi_masuk/update')), /*checked-m*/
    array('disposisi',                                      1, array('sipas/disposisi_masuk',
    ...
    array('disposisi',                                      1, array('sipas/disposisi_masuk_log',
                                                                     'sipas/disposisi_masuk_log/index',
                                                                     'sipas/disposisi_masuk_log/generate_id',
                                                                     'sipas/disposisi_masuk_log/respon',
                                                                     'sipas/disposisi_masuk_log/read')), /*checked-m*/
    //disposisi_referensi
    array('disposisi',                                      1, array('sipas/disposisi_referensi',
                                                                     'sipas/disposisi_referensi/index',
                                                                     'sipas/disposisi_referensi/read')), /*checked-m*/
    //disposisi_riwayat
    array('riwayat_disposisi',                              1, array('sipas/disposisi_riwayat',
                                                                     'sipas/disposisi_riwayat/index',
                                                                     'sipas/disposisi_riwayat/read')), /*checked-m*/
    //dokumen
    array('dokumen',                                        1, array('sipas/dokumen/create',
                                                                     ...
                                                                     'sipas/dokumen/sdoc')), /*checked-m*/
    array('dokumen',                                        1, array('sipas/dokumen/update',
    ...
    array('dokumen',                                        1, array('sipas/dokumen/destroy',
                                                                     'sipas/dokumen/destroy/dokumen',
                                                                     'sipas/dokumen/destroy/link',
                                                                     'sipas/dokumen/destroy/sdoc')), /*checked-m*/
    array('dokumen',                                        0, array('sipas/dokumen/preview',
                                                                     'sipas/dokumen/printSdoc')),
    array('dokumen',                                        1, array('sipas/dokumen',
                                                                     'sipas/dokumen/index',
                                                                     'sipas/dokumen/read',
                                                                     'sipas/dokumen/view',
                                                                     ...
                                                                     'sipas/dokumen/isMaxs')), /*checked-m*/
    //dokumen_log
    array('dokumen',                                        1, array('sipas/dokumen_log',
                                                                     'sipas/dokumen_log/index',
                                                                     'sipas/dokumen_log/read',
                                                                     'sipas/dokumen_log/read/trace',
                                                                     'sipas/dokumen_log/report')),/*has been checked by Luqni Maulana*/
    //ekspedisi
    ...
    array('ekspedisi',                                      1, array('sipas/ekspedisi',
                                                                     'sipas/ekspedisi/index',
                                                                     'sipas/ekspedisi/read',
                                                                     'sipas/ekspedisi/aktif',
                                                                     'sipas/ekspedisi/nonaktif')),/*has been checked by Luqni Maulana*/

    //email
    array('email_queue',                                    1, array('sipas/email/send_queue',
                                                                     'sipas/email/retry_queue')),
    array('email_queue',                                    1, array('sipas/email/index',
                                                                     'sipas/email/getEmailConfig',
                                                                     'sipas/email/test')), /*checked-m*/
    //fitur
    array('fitur',                                          1, array('sipas/fitur/create')),
    array('fitur',                                          1, array('sipas/fitur/update')),
    array('fitur',                                          1, array('sipas/fitur/destroy')),
    array('fitur',                                          1, array('sipas/fitur',
                                                                     'sipas/fitur/index',
                                                                     'sipas/fitur/read')), /*checked-m*/
    //help
    array('support',                                        1, array('sipas/help',
                                                                     'sipas/help/index',
                                                                     'sipas/help/help')), /*checked-m*/
    //itipe
    array('tipe_surat_internal',                            1, array('sipas/itipe',
                                                                     'sipas/itipe/index',
                                                                     'sipas/itipe/read',
                                                                     'sipas/itipe/combo',
                                                                     'sipas/itipe/aktif',
                                                                     'sipas/itipe/nonaktif')), /*checked-m*/
    ...
    array('jabatan',                                        1, array('sipas/jabatan',
                                                                     'sipas/jabatan/index',
                                                                     'sipas/jabatan/read',
    ...
    array('jabatan_tim',                                       1, array('sipas/jabatan_tim',
                                                                     'sipas/jabatan_tim/index',
                                                                     'sipas/jabatan_tim/read')),/*has been checked by Luqni Maulana*/
    ...
    array('jabatan_tim',                                       1, array('sipas/jabatan_tim_anggota',
    ...
    array('jabatan_wakil',                                  1, array('sipas/jabatan_wakil',
    ...
    array('jenis',                                          1, array('sipas/jenis',
                                                                     ...
                                                                     'sipas/jenis/masterSubJenis')),/*has been checked by Luqni Maulana*/
    ...
    array('jenis_telaah',                                   1, array('sipas/jenis_telaah',
                                                                     'sipas/jenis_telaah/index',
                                                                     'sipas/jenis_telaah/read')), /*checked-m*/
    //kelas
    ...
    array('kelas',                                          1, array('sipas/kelas',
                                                                     'sipas/kelas/index',
                                                                     'sipas/kelas/read',
                                                                     ...
                                                                     'sipas/kelas/nonaktif/tree')),/*has been checked by Luqni Maulana*/
    ...
    array('golongan',                                      1, array('sipas/golongan',
    ...
    array('surat_template',                                 1, array('sipas/klise',
                                                                     ...
                                                                     'sipas/klise/preview',
                                                                     'sipas/klise/download')),/*has been checked by Luqni Maulana*/
    ...
    array('surat_template',                                 1, array('sipas/klise_kelompok',
                                                                     'sipas/klise_kelompok/index',
                                                                     'sipas/klise_kelompok/read')), /*checked-m*/
    //kontak
    ...
    array('kontak',                                         1, array('sipas/kontak',
                                                                     'sipas/kontak/index',
                                                                     'sipas/kontak/read',
                                                                     'sipas/kontak/aktif',
                                                                     'sipas/kontak/nonaktif')), /*checked-m*/
    //koreksi
    array('koreksi',                                        1, array('sipas/koreksi/update')),
    array('koreksi',                                        1, array('sipas/koreksi',
                                                                     'sipas/koreksi/index',
                                                                     'sipas/koreksi/read')), /*checked-m*/
    //koreksi_masuk
    array('koreksi',                                        1, array('sipas/koreksi_masuk/update')),
    array('koreksi',                                        1, array('sipas/koreksi_masuk/updateKoreksi')),
    array('koreksi',                                        1, array('sipas/koreksi_masuk',
                                                                     ...
                                                                     'sipas/koreksi_masuk/traceIdKoreksi')),/*has been checked by Luqni Maulana*/
    //korespondensi
    array('korespondensi_surat',                            1, array('sipas/korespondensi/create')),
    array('korespondensi_surat',                            1, array('sipas/korespondensi',
                                                                     ...
                                                                     'sipas/korespondensi/perihal')), /*checked-m*/
    //lacak_surat
    /*
    ...
    array('lokasi',                                         1, array('sipas/lokasi',
                                                                     'sipas/lokasi/index',
                                                                     'sipas/lokasi/read',
                                                                     'sipas/lokasi/aktif',
                                                                     'sipas/lokasi/nonaktif')),/*has been checked by Luqni Maulana*/
    ...
    array('media',                                          1, array('sipas/media',
                                                                     'sipas/media/index',
                                                                     'sipas/media/read',
                                                                     'sipas/media/aktif',
                                                                     'sipas/media/nonaktif')),/*has been checked by Luqni Maulana*/

    //mobile
    array('mobile',                                         1, array('sipas/mobile',
                                                                     'sipas/mobile/index',
                                                                     'sipas/mobile/info')),/*has been checked by Luqni Maulana*/
    ...
    array('notifikasi',                                     1, array('sipas/notifikasi',
                                                                     ...
                                                                     'sipas/notifikasi/notifikasi_retry')), /*checked-m*/
    //pelaporan
    array('pelaporan',                                      1, array('sipas/pelaporan',
                                                                     ...
                                                                     'sipas/pelaporan/get_date_range')),/*has been checked by Luqni Maulana*/
    //pelaporan_sla
    array('pelaporan',                                      1, array('sipas/pelaporan_sla',
                                                                     ...
                                                                     'sipas/pelaporan_sla/get_date_range')),/*has been checked by Luqni Maulana*/
    //pengaturan
    array('pengaturan_sistem',                              1, array('sipas/pengaturan',
                                                                     ...
                                                                     'sipas/pengaturan/getSettingByCode')),/*has been checked by Luqni Maulana*/
    //peran
    ...
    array('hakakses',                                       1, array('sipas/peran',
                                                                     'sipas/peran/index',
                                                                     'sipas/peran/generate_id',
                                                                     'sipas/peran/read',
                                                                     'sipas/peran/aktif',
                                                                     'sipas/peran/nonaktif')),/*has been checked by Luqni Maulana*/
    //perintah
    ...
    array('perintah',                                       1, array('sipas/perintah',
                                                                     'sipas/perintah/index',
                                                                     'sipas/perintah/read',
                                                                     'sipas/perintah/aktif',
                                                                     'sipas/perintah/nonaktif')),/*has been checked by Luqni Maulana*/
    ...
    array('prioritas',                                      1, array('sipas/prioritas',
                                                                     'sipas/prioritas/index',
                                                                     'sipas/prioritas/read',
                                                                     'sipas/prioritas/getHari',
                                                                     'sipas/prioritas/aktif',
                                                                     'sipas/prioritas/nonaktif')),/*has been checked by Luqni Maulana*/

    //properti
    array('properti',                                       1, array('sipas/properti',
                                                                     'sipas/properti/index',
                                                                     'sipas/properti/read')), /*checked-m*/
    //properti_log
    array('properti',                                       1, array('sipas/properti_log',
                                                                     'sipas/properti_log/index',
                                                                     'sipas/properti_log/read')),/*has been checked by Luqni Maulana*/
    //report
    array('pelaporan',                                      1, array('sipas/report',
                                                                     'sipas/report/index',
                                                                     'sipas/report/generate_report')),/*has been checked by Luqni Maulana*/
    //retensi
    ...
    array('retensi',                                        1, array('sipas/retensi',
                                                                     'sipas/retensi/index',
                                                                     'sipas/retensi/read',
                                                                     'sipas/retensi/aktif',
                                                                     'sipas/retensi/nonaktif')),/*has been checked by Luqni Maulana*/
    ...
    array('sifat',                                          1, array('sipas/sifat',
                                                                     ...
                                                                     'sipas/sifat/nonaktif/tree')),/*has been checked by Luqni Maulana*/
    ...
    array('sla',                                            1, array('sipas/sla',
                                                                     'sipas/sla/index',
                                                                     'sipas/sla/read',
                                                                     'sipas/sla/aktif',
                                                                     'sipas/sla/nonaktif')),/*has been checked by Luqni Maulana*/
    ...
    array('sla_kuis',                                       1, array('sipas/sla_kuis',
                                                                     'sipas/sla_kuis/index',
                                                                     'sipas/sla_kuis/read')), /*checked-m*/
    ...
    array('sla_rumus',                                      1, array('sipas/sla_rumus',
                                                                     'sipas/sla_rumus/index',
                                                                     'sipas/sla_rumus/read')),/*has been checked by Luqni Maulana*/
    //sla_ujian
    ...
    array('sla_ujian',                                      1, array('sipas/sla_ujian',
                                                                     'sipas/sla_ujian/index',
                                                                     'sipas/sla_ujian/read')), /*checked-m*/
    //sla_unit
    ...
    array('sla_unit',                                       1, array('sipas/sla_unit',
                                                                     'sipas/sla_unit/index',
                                                                     'sipas/sla_unit/read',
                                                                     'sipas/sla_unit/default')), /*has been checked by Luqni Maulana*/
    //sms_phones
    array('sms_phones',                                     1, array('sipas/sms_phones',
                                                                     'sipas/sms_phones/index',
                                                                     'sipas/sms_phones/status',
                                                                     'sipas/sms_phones/check_status')), /*checked-m*/
    //sms_test
    array('sms_test',                                       1, array('sipas/sms_test',
                                                                     'sipas/sms_test/index',
                                                                     'sipas/sms_test/send_sms')), /*checked-m*/
    //staf
    ...
    array('akun',                                           1, array('sipas/staf_akun',
    ...
    array('staf_tim',                                       1, array('sipas/staf_tim',
                                                                     'sipas/staf_tim/index',
                                                                     'sipas/staf_tim/read')),/*has been checked by Luqni Maulana*/
    ...
    array('staf_tim',                                       1, array('sipas/staf_tim_anggota',
    ...
    array('staf_wakil',                                     1, array('sipas/staf_wakil',
    ...
    array('staf_pgs',                                       1, array('sipas/staf_wakil_pgs',
                                                                     'sipas/staf_wakil_pgs/index',
                                                                     'sipas/staf_wakil_pgs/read',
                                                                     'sipas/staf_wakil_pgs/check',
                                                                     'sipas/staf_wakil_pgs/konfirmasi')),
    //staf_wakil_asisten
    array('staf_wakil',                                     1, array('sipas/staf_wakil_asisten',
                                                                     'sipas/staf_wakil_asisten/index',
                                                                     'sipas/staf_wakil_asisten/read',
                                                                     'sipas/staf_wakil_asisten/read/available')), /*checked-m*/
    //support
    array('support',                                        1, array('sipas/support',
                                                                     'sipas/support/doc')), /*checked-m*/
    //surat lib nomor
    array('surat',      1, array(
    ...
    array('surat',                                          1, array('sipas/surat',
                                                                     'sipas/surat/index',
                                                                     'sipas/surat/read',
    ...
    //surat_ekspedisi
    array('masuk_ekspedisi',                                1, array('sipas/surat_ekspedisi',
    ...
    array('surat_internal_keluar',                          1, array('sipas/surat_ikeluar',
    ...
    array('surat_internal_masuk',                           1, array('sipas/surat_imasuk',
    ...
    array('surat_internal',                                 1, array('sipas/surat_internal',
                                                                     ...
                                                                     'sipas/surat_internal/get_latest_penyetuju')), /*checked-m*/
    //surat_keluar
    ...
    array('keluar',                                         1, array('sipas/surat_keluar',
    ...
    //surat_keputusan
    array('surat_keputusan',                                   0, array('sipas/surat_keputusan/get_template_kolektif',
    ...
    array('surat_internal_keputusan',                          1, array('sipas/surat_keputusan',
    ...
    array('ekspedisi_surat_keluar',                         1, array('sipas/surat_keluar_ekspedisi',
                                                                     'sipas/surat_keluar_ekspedisi/index',
                                                                     'sipas/surat_keluar_ekspedisi/read')), /*checked-m*/
    //surat_kontak
    array('surat_kontak',                                   1, array('sipas/surat_kontak',
                                                                     'sipas/surat_kontak/index',
                                                                     'sipas/surat_kontak/read')), /*checked-m*/
    //surat_log
    array('ekspedisi_surat_keluar_add',                     1, array('sipas/surat_log/create')),
    array('surat',                                          1, array('sipas/surat_log/update')),
    array('surat',                                          1, array('sipas/surat_log',
                                                                     'sipas/surat_log/index',
                                                                     'sipas/surat_log/ekspedisi',
                                                                     'sipas/surat_log/read')), /*checked-m*/
    //surat_masuk
    ...
    array('registrasi',                                     1, array('sipas/surat_masuk',
    ...
    array('surat_stack',                                    1, array('sipas/surat_stack',
                                                                     ...
                                                                     'sipas/surat_stack/petikan')), /*checked-m*/
    //surat_penerimask
    ...
    array('surat_penerimask',                                    1, array('sipas/surat_penerimask',
                                                                     ...
                                                                     'sipas/surat_penerimask/print_tujuan_penerima')), /*checked-m*/
    //surat_status
    ...
    array('surat_status',                                   1, array('sipas/surat_status',
                                                                     'sipas/surat_status/index',
                                                                     'sipas/surat_status/read')), /*checked-m*/
    //surat_ulasan
    ...
    array('surat_internal_masuk_rating',                    1, array('sipas/surat_ulasan',
                                                                     'sipas/surat_ulasan/index',
                                                                     'sipas/surat_ulasan/read',
                                                                     'sipas/surat_ulasan/report_penerima',
                                                                     'sipas/surat_ulasan/report_pengirim',
                                                                     'sipas/surat_ulasan/rating_generator')), /*checked-m*/
    //surat_unit
    array('surat_unit',                                     1, array('sipas/surat_unit',
                                                                     'sipas/surat_unit/index',
                                                                     'sipas/surat_unit/read')), /*checked-m*/
    //system
    array('system',                                         1, array('sipas/system',
                                                                     'sipas/system/index',
                                                                     'sipas/system/backup_create',
                                                                     'sipas/system/backup_state')), /*checked-m*/
    //unit
    ...
    array('unitkerja',                                      1, array('sipas/unit',
                                                                     'sipas/unit/index',
                                                                     'sipas/unit/read',
    ...
    array('unitkerja_kewenangan',                           1, array('sipas/unit_cakupan',
                                                                     'sipas/unit_cakupan/index',
                                                                     'sipas/unit_cakupan/read')),/*has been checked by Luqni Maulana*/
    //user_note
    ...
    array('user_note',                                      1, array('sipas/user_note',
                                                                     'sipas/user_note/index',
                                                                     'sipas/user_note/read')), /*checked-m*/
    //user_log
    ...
    array('user_log',                                       1, array('sipas/user_log',
                                                                     'sipas/user_log/index',
                                                                     'sipas/user_log/read')), /*checked-m*/
    //usermail
    array('usermail',                                       1, array('sipas/usermail',
                                                                     'sipas/usermail/index',
                                                                     'sipas/usermail/select',
                                                                     'sipas/usermail/read',
                                                                     'sipas/usermail/openmail')), /*checked-m*/
    ...
    array('kotak_masuk',                                    1, array('sipas/kotak_masuk',
    ...
    array('terkirim',                                       1, array('sipas/terkirim',
                                                                     'sipas/terkirim/read',
    ...
    array('draft',                                          1, array('sipas/draft',
                                                                     'sipas/draft/read',
    ...
    array('notif_agenda',                                   1, array('sipas/notif_agenda',
    ...
    array('notif_user',                                     1, array('sipas/notif_user',
    ...
    array('disposisi_perintah_log',                         1, array('sipas/disposisi_perintah_log',
                                                                     'sipas/disposisi_perintah_log/index',
                                                                     'sipas/disposisi_perintah_log/read',
                                                                     'sipas/disposisi_perintah_log/create')),
				
    array('worker',                                         0, array('worker/disposisi', 
                                                                     'worker/imasuk',
                                                                     'worker/koreksi')),

    array('dms_dokumen',                                    5, array('dms/dokumen',
                                                                     'dms/dokumen/read',
                                                                     'dms/dokumen/selesai',
                                                                     'dms/dokumen/download',
                                                                     'dms/dokumen/setImport')),

    array('dms_staf',                                       5, array('dms/staf',
                                                                     'dms/staf/read')),

    array('dms_unit',                                       5, array('dms/unit',
                                                                     'dms/unit/read')),

    array('dms_jabatan',                                    5, array('dms/jabatan',
                                                                     'dms/jabatan/read'))
);