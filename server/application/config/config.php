...
|
*/
$config['base_url'] = isset($_SERVER['argc']) ? ('cli://'.dirname($_SERVER['SCRIPT_NAME'])) : ('http'.((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == 'on') ? 's' : '').'://'.$_SERVER['HTTP_HOST'].str_replace('//','/',dirname($_SERVER['SCRIPT_NAME']).'/'));;
...
|
*/
$config['modules_locations'] = array(dirname(APPPATH) . '/modules/');
define("MODULEPATH", $config['modules_locations'][0]);
/*
|--------------------------------------------------------------------------
| Index File
|--------------------------------------------------------------------------
...
$config['sess_cookie_name'] = 'sipas_publish_timah_5_28_src';
