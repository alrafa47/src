		...
		<table style="width:100%; font-family:Arial; font-size:11px; border-collapse: collapse; border: 1px solid #757575; border-collapse: collapse;">
			...
			<tbody>
				...
				<tr style="{bg_color}">
					...
					<td style="padding:2px; font-size:11px; font-weight: bold; line-height: 24px; vertical-align: top; text-align: left; color: #000000;">({surat_agenda}){surat_nomor}</td>
				...
				<tr style="{bg_color}">
					...
					<td style="padding-left:20px; font-size:11px; line-height: 18px; vertical-align: top; text-align: left;">
						{ulasan_staf_nama}<br>Tgl. <span style="color:#757575;">{ulasan_tanggal}</span>
					</td>
