		...
		<table style="width:100%; font-family:Arial; font-size:11px; border-collapse: collapse; border: 1px solid #757575; border-collapse: collapse;">
			<thead style="font-size:12px;">
				...
				<tr style="background-color:#9E9E9E;">
					...
					<td style="color:#FFFFFF; vertical-align: top; width:20%; padding:2px; font-size: 13px; line-height:28px; text-align:center;">Rentang SLA</td>
				</tr>
			</thead>
			<tbody style="font-size:11px;">
				...
				<tr style="{bg_color}">
					...
					<td style="padding:2px; font-size:11px; line-height: 24px; vertical-align: top; text-align: center;">{surat_setuju_tgl} - {dalam_proses}</td>
				</tr>
				{/surat}
			</tbody>
		</table>
