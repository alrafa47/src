	...
	<div class="paper" style="width:100%; margin:0px auto; padding: 0px; font-family:Arial; font-size:11px;">
		...
		<table style="width:100%; font-family:Arial; font-size:11px; border-collapse: collapse; border: 1px solid #757575; border-collapse: collapse;">
			...
			<tr style="background-color:#9E9E9E; font-size:12px;">
				...
				<td style="color:#FFFFFF; vertical-align: center; width:15%; padding:2px; font-size: 13px; line-height:28px; text-align:center;" rowspan="2">Nama Penerima</td>
				<td style="color:#FFFFFF; vertical-align: center; width:15%; padding:2px; font-size: 13px; line-height:28px; text-align:center;" rowspan="2">Jabatan</td>
