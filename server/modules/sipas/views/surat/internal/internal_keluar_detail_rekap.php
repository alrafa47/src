		...
		<table style="width:100%; font-family:Arial; font-size:11px; border-collapse: collapse; border: 1px solid #757575;">
			<thead style="font-size:12px;">
				...
				<tr style="background-color:#9E9E9E; font-size:12px;">
					<td style="color:#FFFFFF; vertical-align: top; width:25%; padding:2px 8px; font-size: 13px; line-height:28px; text-align:left;">Tipe Surat</td>
			...
			<tbody>
				{jenis_data}
				<tr style="{bg_color}">
					<td style=" padding:2px 8px; font-size:11px; line-height: 24px; vertical-align: top; text-align: left;">{jenis_nama}</td>
					...
					<td style="padding:2px; font-size:11px; line-height: 24px; vertical-align: top; text-align: center;">{proses}</td>
