		...
		<table style="width:100%; font-family:Arial; font-size:11px; border-collapse: collapse; border: 1px solid #757575; border-collapse: collapse;">
			...
			<tbody style="vertical-align: top; font-size:11px;">
				...
				<tr style="{bg_color}">
					...
					<td style="padding:2px; font-size:11px; line-height: 24px; vertical-align: top; text-align: left;">{jenis_nama}</td>
					<td style="padding:2px; font-size:11px; line-height: 24px; vertical-align: top; text-align: center;">{surat_jenis_count}</td>
				</tr>
				{/records}
			</tbody>
		</table>
