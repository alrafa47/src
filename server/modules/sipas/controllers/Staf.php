...
class Staf extends Base_Controller {
    ...
    function penerima_disposisi_custom($section=null){ // section = [recent,available] // for mobile search
        $me = $this;
        $model              = $me->m_staf_aktual_view;
        $pegawaiModel       = $me->m_staf_view;
        $pegawaiModelAktif  = $me->m_staf_aktif;
    ...
    function penerima_disposisi($section=null){ // section = [recent,available]
        $me = $this;
        $model               = $me->m_staf_aktual_view;
        $pegawaiModel        = $me->m_staf_view;
        $pegawaiModelAktif   = $me->m_staf_aktif;
