                ...
                if (empty($data['surat_korespondensi_surat'])) {
                    ...
                    if (empty($data['surat_korespondensi'])) {
                        $this->m_korespondensi->insert(
                            ...
                            null,
                            function ($r_korespondensi) use ($response, $model, $properti, $account_id, $surat_view) {
                ...
                if (empty($data['surat_korespondensi_surat'])) {
                    ...
                    if (empty($data['surat_korespondensi'])) {
                        $this->m_korespondensi->insert(
                            ...
                            null,
                            function ($r_korespondensi) use ($response, $model, $properti, $account_id) {
                                if ($r_korespondensi[$model->successProperty] !== true) return;
