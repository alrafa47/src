...
class Sipas_model_Kelas_view extends Sipas_model_Kelas {
    
    function __construct(){
        parent::__construct();
        $this->set_table_name('v_kelas');
        $this->set_fields(array(
            ...
            array('insert'=>false, 'update'=>false, 'name'=>'kelas_parent_path'),
            array('insert'=>false, 'update'=>false, 'name'=>'kelas_jenis'),
            array('insert'=>false, 'update'=>false, 'name'=>'kelas_jenis_id'),
            array('insert'=>false, 'update'=>false, 'name'=>'kelas_jenis_kode'),
            array('insert'=>false, 'update'=>false, 'name'=>'kelas_jenis_nama'),
            array('insert'=>false, 'update'=>false, 'name'=>'kelas_isaktif'),
            array('insert'=>false, 'update'=>false, 'name'=>'kelas_properti'),
            array('insert'=>false, 'update'=>false, 'name'=>'kelas_induk_id'),
            array('insert'=>false, 'update'=>false, 'name'=>'kelas_induk_nama'),
