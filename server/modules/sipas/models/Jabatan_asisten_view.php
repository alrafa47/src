...
class Sipas_model_Jabatan_asisten_view extends Sipas_model_Jabatan_wakil {
    
    public function __construct(){
        parent::__construct();
        $this->set_table_name('v_jabatan_asisten');
    ...
    //         {
    //             $value['staf_image_preview'] = $_SERVER['REQUEST_SCHEME'].'://'.$_SERVER['HTTP_HOST'].$_SERVER['SCRIPT_NAME'].'/sipas/staf/get_image/foto?id='.$value['jabatan_wakil_asisten_staf'];
    //         }
    //     }
