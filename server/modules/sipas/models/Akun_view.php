...
class Sipas_model_Akun_view extends sipas_model_Akun
{
    function __construct()
    {
        ...
        $this->set_fields(array(
            ...
            array('name' => 'akun_unit_id',     'display' => 'Unit Id',          'update' => false, 'insert' => false),
            array('name' => 'akun_unit_nama',     'display' => 'Unit Nama',          'update' => false, 'insert' => false),
            array('name' => 'akun_unit_induk',     'display' => 'Unit Induk',          'update' => false, 'insert' => false),
        ));
    }
}
