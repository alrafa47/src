                ...
                if($use_setting == '1' && $inserted_data['surat_setuju'] == 2){
                    ...
                    if(!empty($penerima)){
                        ...
                        $disposisi->insert(
                            ...
                            $penerima, $now, $account_id, $akun, $disposisi, $disposisi_masuk, $model_staf,
                            $properti, $surat_stack, $me, $staf_aktual, $jabatan_aktual, $surat_data, $surat,
                            $inserted_data, $queueTube, $queueTubeRedis, $worker_mode, 
                            $queuetubeDisposisi, $disposisi_masuk_view){
